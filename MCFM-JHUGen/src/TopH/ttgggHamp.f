      ...
      include 'constants.f'
      include 'masses.f'
      double precision q(mxpart,4),s234mmtsq,
     ...
     & p2345(4),p15(4),p145(4),ampABC(2,2,2,2,2)
      ...
      s145=dble(p145(4)**2-p145(1)**2-p145(2)**2-p145(3)**2)
...
c      if (h2 .eq. 2) e2(:)=e2p(:)
     ...
     &    s145mmtsq**(-1)*s15mmtsq**(-1)*s23mmtsq**(-1)
      ...
      do h5=1,2
!      h2=2
      ampABC(h1,2,h3,h4,h5)=-(-1)**h1*dconjg(ampABC(3-h1,1,h3,h4,h5))
      enddo
      enddo
      enddo
      enddo
