...
************************************************************************
      ...
      include 'masses.f'
      double complex mab(2,2),mba(2,2)
      double precision denr,denb,denq1,denq2,dena1,dena2,wtgg,s12
      integer h1,h2
     ...
     &    ,b2)*zb(p1,p4)*zb(p1,b2)*s12**(-1) )
      ...
      do h1=1,2
      do h2=1,2
      wtgg=wtgg+cdabs(mab(h1,h2))**2+cdabs(mba(h1,h2))**2
     & -1d0/xn**2*cdabs(mab(h1,h2)+mba(h1,h2))**2
      enddo
      enddo
      return
      end
