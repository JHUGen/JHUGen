c---- Note added: John Campbell, May 2015
c---- This routine taken from
c---- http://people.sc.fsu.edu/~jburkardt/f_src/mpi_stubs/mpi_stubs.html
c----
c---- and  modified as follows:
c----  1. Minimal formatting changes to be 72-character compliant
c----  2. Changed include file from 'mpi_stubs_f90.h' to 'mpif.h'
c----
     ...
     &  nrecv, recvtype, comm, ierror )
      ...
      subroutine mpi_allgatherv ( data1, nsend, sendtype, data2,
     &   nrecv, ndispls, recvtype, comm, ierror )
     ...
     &           ( data, n, datatype, iproc, itag, comm, ierror )
     ...
     & idest, ierror )
      ...
      subroutine mpi_irecv ( data, n, datatype, iproc, itag, comm,
     &  irequest, ierror )
      ...
      subroutine mpi_isend ( data, n, datatype, iproc, itag, comm,
     &  request, ierror )
      ...
      subroutine mpi_recv ( data, n, datatype, iproc, itag, comm,
     & istatus, ierror )
     ...
     &           ( data1, data2, n, operation, ierror )
      ...
      subroutine mpi_reduce_double_precision ( data1, data2, n,
     &  operation, ierror )
...
! Trivial copy of mpi_reduce_integer by J. Campbell, 5/4/2016
      ...
      !
        ...
        integer(kind=8) data1(n)
        integer(kind=8) data2(n)
        integer ierror
        integer operation
