...
************************************************************************
      ...
      include 'agq.f'
      integer is
      double precision z,xl12,xl14,xl24,p(mxpart,4),dot
...
c--- sum over regular and plus terms
      do is=1,3
c--- (q,qb) terms
c      Q1(q,q,a,is) =ason4pi*xn*(if_qq(z,xl14,is)+0.5d0*fi_gg(z,xl14,is)
c     &                            -ii_qq(z,xl12,is)/xnsq)
c      Q1(a,a,q,is)=Q1(q,q,a,is)
c      Q2(a,a,q,is)=ason4pi*xn*(if_qq(z,xl24,is)+0.5d0*fi_gg(z,xl24,is)
c     &                            -ii_qq(z,xl12,is)/xnsq)
...
c      Q2(a,g,q,is)=ason4pi*2d0*tr*ii_qg(z,xl12,is)
...
c      Q1(a,g,q,is)=ason4pi*2d0*tr*ii_qg(z,xl12,is)
