      double precision function qg_tbqndk_ampanti(p1,p2,p3,p4,p7,
...
c     q(-p1)+g(-p2)--> t(p3,p4,p5)+bb(p6)+q'(p7)
      ...
      double complex resp,resm,za345b,za167b,zanb(mxpart,mxpart)
      double precision c6,prop26,prop167,s167,twonDpt,twonDp6
...
c--- statement functions
     ...
     &    p1)*s167 + za(p7,k6)*zanb(p3,p1)*mt**2 )
      ...
      qg_tbqndk_ampanti=cdabs(resp)**2+cdabs(resm)**2
