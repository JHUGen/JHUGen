...
! this checks the decay rates without production dynamics
  ...
  enddo
   ...
   p13(1:4,3)=(/     2.0695031298922770d0,       -1.3995194639860060d0,       0.4309336522215461d0,2      -0.74896506056107459d0     /)
   ...
   print *, 'Matr.el. squared,gg->ttbH',MatElSq,MatElSq/3.86846524452681070d-002
   call EvalAmp_QQB_TTBH(p13(1:4,1:13),MatElSq)
   print *, 'Matr.el. squared,qqb->ttbH',MatElSq,MatElSq/0.10201500344672357d0
