...
IMPLICIT NONE
 ...
 public :: EvalXSec_PP_TH,EvalXSec_PP_TBH 
 public :: EvalAmp_QB_TH, EvalAmp_QbarBbar_TbarH
...
SUBROUTINE EvalXSec_PP_TbH(Mom,TTBHcoupl,TopDecays,Res)
implicit none
...
include 'includeVars.F90'
      ...
      call NNevolvePDF(x2,PDFScale,NNpdf(2,-6:7))
      Res = &
            + LO_Res_Unpol(Dn_,ABot_)  * ( NNpdf(Dn_,1)*NNpdf(ABot_,2)  + NNpdf(Str_,1)*NNpdf(ABot_,2) )    &
