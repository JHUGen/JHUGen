...
************************************************************************
      ...
      double complex  prop
      double complex  mtop(2,2),mtopv(2,2),manti(2,2),mantiv(2,2),
...
c      if ((case .eq. 'tt_bbh') .or. (case .eq. 'tt_hdk')) fac=2d0*xn*fac
     ...
     & *dble(dconjg(mtotqg(hb,h2,hc))*mtotqgv(hb,h2,hc))
      msq_gq=msq_gq+fac*aveqg
     & *dble(dconjg(mtotgq(hb,h2,hc))*mtotgqv(hb,h2,hc))
      msq_qbg=msq_qbg+fac*aveqg
     & *dble(dconjg(mtotqbg(hb,h2,hc))*mtotqbgv(hb,h2,hc))
      msq_gqb=msq_gqb+fac*aveqg
     & *dble(dconjg(mtotgqb(hb,h2,hc))*mtotgqbv(hb,h2,hc))
      enddo
      enddo
      enddo
