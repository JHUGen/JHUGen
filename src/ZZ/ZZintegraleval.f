...
C-----Author: Keith Ellis, September 2013
      ...
      include 'docheck.f'
      include 'qlfirst.f'
      double precision k(mxpart,4)
      integer nu
      double precision p1(4),p2(4),p3(4),p4(4),mt,mt2,
     & s12,s13,s23,s14,s24,s34,p3sq,p4sq
      double complex qlI4,qlI3,qlI2,qlI4_6explicit
C      double complex qlI4_6
...
c      D0(d1_34_2)=czip
      ...
      double complex function qlI4_6explicit(s34,s56,s12,s234,mtsq,musq
...
c--- as arguments
      implicit none
      double precision s34,s56,s12,s234,s134,musq,mtsq,Y
      double complex D0,C0_1,C0_2,C0_3,C0_4,xD0,xC0(4)

c      D0=qlI4(0d0,0d0,s34,s56,s12,s234,mtsq,mtsq,mtsq,mtsq,musq,0)
c      C0_1=qlI3(0d0,s34,s234,mtsq,mtsq,mtsq,musq,0)
c      C0_2=qlI3(s12,s34,s56,mtsq,mtsq,mtsq,musq,0)
c      C0_3=qlI3(0d0,s234,s56,mtsq,mtsq,mtsq,musq,0)
c      C0_4=qlI3(0d0,0d0,s12,mtsq,mtsq,mtsq,musq,0)
      
      s134=s56+s34-s12-s234
      Y=((s134-s34)*(s234-s34)-s12*s34)
            
      xD0=-s12*s234-4d0*mtsq/s234*Y
      xC0(1)=s234-s34
     ...
     & *s234/(2d0*Y)
      ...
      double complex function qlI4_6(s34,s56,s12,s234,mtsq,musq)
c--- Evaluates the 6-dimensional scalar "hard" box integral
c--- formula taken from sixdim.prc
      implicit none
      double precision s34,s56,s12,s234,s134,musq,mtsq,Y
      double complex D0,C0(4),xD0,xC0(4),qlI3,qlI4

      D0=qlI4(0d0,0d0,s34,s56,s12,s234,mtsq,mtsq,mtsq,mtsq,musq,0)
      C0(1)=qlI3(0d0,s34,s234,mtsq,mtsq,mtsq,musq,0)
      C0(2)=qlI3(s12,s34,s56,mtsq,mtsq,mtsq,musq,0)
      C0(3)=qlI3(0d0,s234,s56,mtsq,mtsq,mtsq,musq,0)
      C0(4)=qlI3(0d0,0d0,s12,mtsq,mtsq,mtsq,musq,0)
