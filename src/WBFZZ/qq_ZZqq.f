...
C---setup spinors and spinorvector products
      ...
      if ((plabel(3) .eq. 'uq')
     & .or. (plabel(3) .eq. 'bq')
     & .or. (plabel(3) .eq. 'qj')) then
        colfac34_56=colfac34_56*xn
      endif
      if ((plabel(5) .eq. 'uq')
     & .or. (plabel(5) .eq. 'bq')
     & .or. (plabel(5) .eq. 'qj')) then
        colfac34_56=colfac34_56*xn
      endif
...
C-----setup for (uqbq_uqbq) (2,5)->(2,5)
      ...
      temp(2,5)=temp(2,5)+esq**6*spinavge*colfac34_56
...
C-----setup for (uqcq_uqcq) (2,4)->(2,4)
      ...
      temp(2,4)=temp(2,4)+esq**6*spinavge*colfac34_56
...
C-----setup for uqsq_dqcq W diagrams (2,3)->(1,4)
      ...
      tempw(2,3)=tempw(2,3)+esq**6*spinavge*colfac34_56
...
C-----setup for dqcq_uqsq (1,4)-->(2,3)
      ...
      tempw(1,4)=tempw(1,4)+esq**6*spinavge*colfac34_56
...
C-----setup for (dqcq_dqcq) (1,4)-->(1,4)
      ...
      temp(1,4)=temp(1,4)+esq**6*spinavge*colfac34_56
...
C-----setup for dquq_dquq W diagrams (1,2)-->(1,2)
      ...
      temp(1,2)=temp(1,2)+esq**6*spinavge*colfac34_56
     ...
     & *dconjg(ampb(dquq_dquq,h1,h2,h3,h5)))
      ...
      temp(1,2)=temp(1,2)-2d0/xn*esq**6*spinavge*colfac34_56
     &   *dble(ampa(dquq_dquq,h1,h2,h3,h5)
     & *dconjg(ampb(dquq_dquq,h1,h2,h3,h5)))
      endif
...
C-----setup for (dqsq_dqsq) (1,3)-->(1,3)
      ...
      temp(1,3)=temp(1,3)+esq**6*spinavge*colfac34_56
...
C-----setup for ((uquq_uquq)  (2,2)-->(2,2)
      ...
      temp(2,2)=temp(2,2)+esq**6*spinavge*colfac34_56
     ...
     & *dconjg(ampb(uquq_uquq,h1,h2,h3,h5)))
      if (h1 .eq. h2) then
      temp(2,2)=temp(2,2)-2d0/xn*esq**6*spinavge*colfac34_56
     & *dble(ampa(uquq_uquq,h1,h2,h3,h5)
     & *dconjg(ampb(uquq_uquq,h1,h2,h3,h5)))
      endif
...
C-----setup for ((dqdq_dqdq)  (1,1)-->(1,1)
      ...
      temp(1,1)=temp(1,1)+esq**6*spinavge*colfac34_56
     ...
     & *dconjg(ampb(dqdq_dqdq,h1,h2,h3,h5)))
      if (h1 .eq. h2) then
      temp(1,1)=temp(1,1)-2d0/xn*esq**6*spinavge*colfac34_56
     & *dble(ampa(dqdq_dqdq,h1,h2,h3,h5)
     & *dconjg(ampb(dqdq_dqdq,h1,h2,h3,h5)))
      endif
