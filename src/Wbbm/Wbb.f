...
C     calculated in the Rodrigo scheme
      ...
      double precision m,s167,s267,s134,s234,s34,s345,beta,bm,bp,
     & p3Dq5,p4Dq5
      double complex zba2,helviol,tmp(2,2)
      double complex qedi(2,2,2),qedf(2,2,2),qcda(2,2,2),qcdb(2,2,2)
      double complex zba2153,zba2154,zba2157,zba6175,zba6174,zba6173
      double complex zba3267,zba4267,zba6243,zba5267,zba4351,zba3451
