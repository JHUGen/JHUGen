     ...
     & gameW(2),gamzeq(2,2,2),gamzee(2,2),gamzne(2,2)
      double precision qn,t3,t4,s345,s356,s456,
...
C-----end statement functions
     ...
     & propW3456**(-1) * (  - 1.D0/2.D0*za(p7,p8)*za(p3,p5)*zb(p1,p2)*
     &    zb(p4,p6)*cwmass2**(-1) )
      amp(1,1) = amp(1,1) + gamZee(1,1)*cxw**(-2)*propW17**(-1)*
     & propW3456**(-1)*s127**(-1) * ( 2.D0*za(p7,p1)*za(p3,p8)*za(p4,p5
     &    )*zb(p1,p4)*zb(p1,p2)*zb(p4,p6)*s456**(-1) - 2.D0*za(p7,p1)*
     &    za(p3,p8)*za(p5,p6)*zb(p1,p6)*zb(p1,p2)*zb(p4,p6)*s456**(-1)
     &     + 2.D0*za(p7,p2)*za(p3,p8)*zb(p1,p2)*zb(p4,p6)*zba2(p2,p4,p6
     &    ,p5)*s456**(-1) )
      amp(1,1) = amp(1,1) + gamZee(1,1)*cxw**(-2)*propW17**(-1)*
     & propW3456**(-1) * ( za(p7,p8)*za(p3,p5)*zb(p1,p2)*zb(p4,p6)*
     &    cwmass2**(-1) )
      amp(1,1) = amp(1,1) + gamZne(1,1)*cxw**(-2)*propW17**(-1)*
     & propW3456**(-1)*s127**(-1) * (  - 2.D0*za(p7,p1)*za(p3,p5)*za(p3
     &    ,p8)*zb(p1,p4)*zb(p1,p2)*zb(p3,p6)*s356**(-1) - 2.D0*za(p7,p1
     &    )*za(p3,p5)*za(p5,p8)*zb(p1,p4)*zb(p1,p2)*zb(p5,p6)*
     &    s356**(-1) - 2.D0*za(p7,p2)*za(p3,p5)*zb(p1,p2)*zb(p4,p2)*
     &    zba2(p6,p3,p5,p8)*s356**(-1) )
      amp(1,1) = amp(1,1) + gamZne(1,1)*cxw**(-2)*propW17**(-1)*
     & propW3456**(-1) * (  - za(p7,p8)*za(p3,p5)*zb(p1,p2)*zb(p4,p6)*
     &    cwmass2**(-1) )
      amp(1,1) = amp(1,1) + gamZeq(1,1,1)*cxw**(-2)*propW17**(-1)*
     & propW34**(-1)*s127**(-1) * ( 2.D0*za(p5,p8)*zb(p1,p2)*zba2(p4,p1
     &    ,p2,p7)*zba2(p6,p5,p8,p3)*s568**(-1) )
      amp(1,1) = amp(1,1) + gamZeq(1,1,1)*cxw**(-2)*propW17**(-1)*
     & propW34**(-1)*s348**(-1) * ( 2.D0*za(p3,p8)*zb(p6,p2)*zba2(p1,p2
     &    ,p6,p5)*zba2(p4,p3,p8,p7)*s256**(-1) )
      amp(1,1) = amp(1,1) + gamZeq(2,1,1)*cxw**(-2)*propW17**(-1)*
     & propW34**(-1)*s127**(-1)*s348**(-1) * ( 2.D0*za(p3,p8)*zb(p1,p2)
     &    *zba2(p4,p3,p8,p5)*zba2(p6,p1,p2,p7) )
      amp(1,1) = amp(1,1) + gameW(1)*cxw**(-2)*propW17**(-1)*
     & propW34**(-1)*propW3456**(-1)*s127**(-1) * ( 2.D0*za(p7,p1)*za(
     &    p3,p5)*zb(p1,p2)*zb(p4,p6)*zab2(p8,p3,p4,p1) + za(p7,p1)*za(
     &    p3,p5)*zb(p1,p2)*zb(p4,p6)*zab2(p8,p2,p7,p1) - 2.D0*za(p7,p1)
     &    *za(p5,p8)*zb(p1,p6)*zb(p1,p2)*zab2(p3,p5,p6,p4) + za(p7,p2)*
     &    za(p3,p5)*zb(p1,p2)*zb(p4,p6)*zab2(p8,p1,p7,p2) + 2.D0*za(p7,
     &    p2)*za(p3,p5)*zb(p1,p2)*zb(p4,p6)*zab2(p8,p3,p4,p2) + 2.D0*
     ...
     & s127**(-1) * ( 2.D0*za(p7,p1)*za(p3,p8)*za(p4,p6)*zb(p1,p4)*zb(
     &    p1,p2)*zb(p4,p5)*s456**(-1) + 2.D0*za(p7,p1)*za(p3,p8)*za(p5,
     &    p6)*zb(p1,p5)*zb(p1,p2)*zb(p4,p5)*s456**(-1) + 2.D0*za(p7,p2)
     ...
     & propW3456**(-1)*s127**(-1) * (  - 2.D0*za(p7,p1)*za(p3,p6)*za(p3
     &    ,p8)*zb(p1,p4)*zb(p1,p2)*zb(p3,p5)*s356**(-1) + 2.D0*za(p7,p1
     &    )*za(p3,p6)*za(p6,p8)*zb(p1,p4)*zb(p1,p2)*zb(p5,p6)*
     &    s356**(-1) - 2.D0*za(p7,p2)*za(p3,p6)*zb(p1,p2)*zb(p4,p2)*
     &    zba2(p5,p3,p6,p8)*s356**(-1) )
      amp(1,2) = amp(1,2) + gamZne(1,2)*cxw**(-2)*propW17**(-1)*
     & propW3456**(-1) * (  - za(p7,p8)*za(p3,p6)*zb(p1,p2)*zb(p4,p5)*
     &    cwmass2**(-1) )
      amp(1,2) = amp(1,2) + gamZeq(1,2,1)*cxw**(-2)*propW17**(-1)*
     & propW34**(-1)*s127**(-1) * ( 2.D0*za(p6,p8)*zb(p1,p2)*zba2(p4,p1
     &    ,p2,p7)*zba2(p5,p6,p8,p3)*s568**(-1) )
      amp(1,2) = amp(1,2) + gamZeq(1,2,1)*cxw**(-2)*propW17**(-1)*
     & propW34**(-1)*s348**(-1) * ( 2.D0*za(p3,p8)*zb(p5,p2)*zba2(p1,p2
     ...
     &    p3,p6)*zb(p1,p2)*zb(p4,p5)*zab2(p8,p2,p7,p1) - 2.D0*za(p7,p1)
     &    *za(p6,p8)*zb(p1,p5)*zb(p1,p2)*zab2(p3,p5,p6,p4) + za(p7,p2)*
     &    za(p3,p6)*zb(p1,p2)*zb(p4,p5)*zab2(p8,p1,p7,p2) + 2.D0*za(p7,
     &    p2)*za(p3,p6)*zb(p1,p2)*zb(p4,p5)*zab2(p8,p3,p4,p2) + 2.D0*
     ...
     &    p2)*zba2(p4,p3,p5,p8)*s178**(-1)*s345**(-1) + 1.D0/2.D0*za(p7
     &    ,p8)*za(p3,p5)*zb(p1,p2)*zb(p4,p6)*cwmass2**(-1) )
      amp(2,1) = amp(2,1) + gamZee(1,1)*cxw**(-2)*propW17**(-1)*
     & propW3456**(-1) * (  - 2.D0*za(p7,p3)*za(p7,p8)*zb(p7,p1)*zb(p4,
     &    p6)*zba2(p2,p4,p6,p5)*s178**(-1)*s456**(-1) - za(p7,p8)*za(p3
     &    ,p5)*zb(p1,p2)*zb(p4,p6)*cwmass2**(-1) - 2.D0*za(p7,p8)*za(p3
     &    ,p8)*zb(p1,p8)*zb(p4,p6)*zba2(p2,p4,p6,p5)*s178**(-1)*
     &    s456**(-1) )
      amp(2,1) = amp(2,1) + gamZne(1,1)*cxw**(-2)*propW17**(-1)*
     & propW3456**(-1) * (  - 2.D0*za(p7,p8)*za(p3,p5)*zb(p7,p1)*zb(p4,
     &    p2)*zba2(p6,p3,p5,p7)*s178**(-1)*s356**(-1) + 2.D0*za(p7,p8)*
     ...
     &    p5)*zb(p1,p2)*zb(p4,p6)*zab2(p3,p5,p6,p4)*cwmass2**(-1) - 2.D0
     &    *za(p7,p8)*za(p5,p8)*zb(p1,p8)*zb(p6,p2)*zab2(p3,p5,p6,p4)*
     &    s178**(-1) )
      amp(2,1) = amp(2,1) + gameW(1)*cxw**(-2)*propW17**(-1)*
     & propW34**(-1)*propW3456**(-1) * (  - 2.D0*za(p7,p8)*zb(p4,p2)*
     &    zab2(p5,p3,p4,p6)*zba2(p1,p7,p8,p3)*s178**(-1) )
      amp(2,2)= + gamZee(1,2)*cxw**(-2)*propW17**(-1)*propW3456**(-1)
     &  * (  - 2.D0*za(p7,p3)*za(p7,p8)*zb(p7,p1)*zb(p4,p5)*zba2(p2,p4,
     &    p5,p6)*s178**(-1)*s456**(-1) - za(p7,p8)*za(p3,p6)*zb(p1,p2)*
     &    zb(p4,p5)*cwmass2**(-1) - 2.D0*za(p7,p8)*za(p3,p8)*zb(p1,p8)*
     &    zb(p4,p5)*zba2(p2,p4,p5,p6)*s178**(-1)*s456**(-1) )
      amp(2,2) = amp(2,2) + gamZne(1,2)*cxw**(-2)*propW17**(-1)*
     & propW3456**(-1) * (  - 2.D0*za(p7,p8)*za(p3,p6)*zb(p7,p1)*zb(p4,
     &    p2)*zba2(p5,p3,p6,p7)*s178**(-1)*s356**(-1) + 2.D0*za(p7,p8)*
     ...
     & propW34**(-1) * ( 2.D0*za(p7,p8)*zb(p4,p2)*zba2(p1,p7,p8,p6)*
     &    zba2(p5,p2,p4,p3)*s178**(-1)*s234**(-1) )
      amp(2,2) = amp(2,2) + gamZeq(2,2,1)*cxw**(-2)*propW17**(-1)*
     & propW34**(-1) * ( 2.D0*za(p7,p8)*zb(p5,p2)*zba2(p1,p7,p8,p3)*
     &    zba2(p4,p2,p5,p6)*s178**(-1)*s256**(-1) + 2.D0*za(p6,p8)*zb(
     &    p4,p2)*zba2(p1,p2,p4,p3)*zba2(p5,p6,p8,p7)*s234**(-1)*
     &    s568**(-1) )
      amp(2,2) = amp(2,2) + gameW(2)*cxw**(-2)*propW17**(-1)*
     & propW34**(-1)*propW3456**(-1) * (  - 2.D0*za(p7,p6)*za(p7,p8)*
     ...
     &    s178**(-1) + 2.D0*za(p7,p8)*za(p3,p6)*zb(p7,p1)*zb(p4,p5)*
     &    zab2(p7,p3,p4,p2)*s178**(-1) - za(p7,p8)*za(p3,p6)*zb(p1,p8)*
     &    zb(p4,p5)*zab2(p8,p1,p7,p2)*s178**(-1) - 2.D0*za(p7,p8)*za(p3
     ...
     &    p6)*zb(p1,p2)*zb(p4,p5)*zab2(p3,p5,p6,p4)*cwmass2**(-1) - 2.D0
