      ...
      double precision mtsq,s134,rat,mtsqps134
      integer k1,k2,k3,k4,k5,k6,i1,i2
      double complex app,apm,amp,amm,zab2,izab2,iza,izb
...
c--- end statement functions
      ...
      rat=mtsq/s(k1,k2)
      mtsqps134=mtsq+s134
      app =  + iza(k1,k2)*mtsq * (  - 2.D0*za(k1,k3)*za(k1,k5)*zb(k1,k2
     ...
     &    rat )
      amm =  + izb(k1,k2)*mtsq * ( 2.D0*za(k1,k2)*za(k1,k3)*za(k2,k5)*
     ...
     &    rat )
      apm =  + mtsq * (  - 2.D0*za(k2,k3)*za(k2,k5)*zb(k1,k4)*zb(k1,k6)
     ...
     & mtsqps134**2 * (  - 4.D0*za(k1,k3)*za(k1,k5)*zb(k2,k4)*zb(k2,k6)
     & )
      apm = apm + izab2(k1,k3,k4,k2)**2*zab2(k2,k3,k4,k1)*mtsq*
     & mtsqps134 * ( 3.D0*za(k1,k3)*za(k1,k5)*zb(k1,k4)*zb(k2,k6) + 3.D0
     ...
     & - 2.D0*za(k1,k3)*za(k1,k5)*zb(k2,k4)*zb(k2,k6)*rat )
      apm = apm + izab2(k1,k3,k4,k2)*zab2(k2,k3,k4,k1)*mtsq * (  - 2.D0
     ...
     &    k3,k4)*zb(k2,k4)*zb(k4,k6) )
      amp =  + mtsq * (  - 2.D0*za(k1,k3)*za(k1,k5)*zb(k2,k4)*zb(k2,k6)
     &    *rat )
     ...
     & mtsqps134**2 * (  - 4.D0*za(k2,k3)*za(k2,k5)*zb(k1,k4)*zb(k1,k6))
      amp = amp + izab2(k2,k3,k4,k1)**2*zab2(k1,k3,k4,k2)*mtsq*
     & mtsqps134 * ( 3.D0*za(k1,k3)*za(k2,k5)*zb(k1,k4)*zb(k1,k6) - 3.D0
     &    *za(k2,k5)*za(k3,k4)*zb(k1,k4)*zb(k4,k6) )
      amp = amp + izab2(k2,k3,k4,k1)**2*zab2(k1,k3,k4,k2)**2*mtsq * ( 
     &     - 2.D0*za(k2,k3)*za(k2,k5)*zb(k1,k4)*zb(k1,k6)*rat )
      amp = amp + izab2(k2,k3,k4,k1)*zab2(k1,k3,k4,k2)*mtsq * ( 2.D0*
