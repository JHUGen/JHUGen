...
(version 3.1.7, release date June 18, 2013) \\
\normalsize
\end{center}
...
\noindent
{\it Only for the 4l final state}, one can include interference effects between the leptons.  The interference is controlled by the command line parameter:
\begin{verbatim}
Interf=0 or 1
\end{verbatim}
...
\noindent
In going from \verb|v2.2.6| to \verb|v3.1.7|, the updates are as follows:
