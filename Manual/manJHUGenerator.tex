...
\begin{verbatim}
  ...
  Resonance parameters:
    ...
    MReso2:            2nd resonance mass in GeV in off-shell VBF
    GaReso2:           2nd resonance width in GeV in off-shell VBF
