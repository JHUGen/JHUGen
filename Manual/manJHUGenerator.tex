...
\section{Modified Zff couplings in MCFM}
We support modified Zff couplings in certain processes in the standalone JHUGen-MCFM package of the JHU Generator Framework. We allow modified Zff couplings both production and decay for $gg \to 4l$ processes. Zff couplings are set separately for production and decay.
...
\noindent 
In going from \verb|v7.5.2| to \verb|v7.5.3| (April 21 2023), the updates are as follows:
\begin{itemize}
\item Add modifications to Zff couplings in $gg \to 4l$ MCFM processes
\item Added new pole scheme
\end{itemize}
\noindent 
