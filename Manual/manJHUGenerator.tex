...
\begin{itemize}
\item
\verb|seed_random| is false, the seeds are set through
\begin{verbatim}
...
\end{verbatim}
All three cuts are used in processes 60, 61, 90, and also 80 if \verb|m_Top| is set to be light ($<10 \text{GeV}$).  \verb|pTjetcut| is also used in process 62 ($H+j$).
