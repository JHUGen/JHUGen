...
(version v5.2.5, release date March 17, 2014) \\
\normalsize
\end{center}
...
\begin{verbatim}
    ...
    Process:    0=spin-0, 1=spin-1, 2=spin-2 resonance, 50=pp/ee->VH,
                60=weakVBF, 61=pp->Hjj, 62=pp->Hj, 80=ttH
...
- $pp \to t\bar{t}+H$:
\begin{verbatim}
./JHUGen Collider=1 Process=80 TopDK=1 Unweighted=1 VegasNc2=100000 OffXVV=011 DataFile=test5
\end{verbatim}
...
\noindent
In going from \verb|v4.8.1| to \verb|v5.2.3|, the updates are as follows:
