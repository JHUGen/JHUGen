...
The couplings used by the Madgraph interface utilize the SMEFTsim package for Madgraph at NLO \cit{SMEFTsim1} \cite{SMEFTsim2}. These are expressed as real-valued Wilson Coefficients, and affect far more than just the amplitudes within couplings.
...
\noindent
In going from \verb|v7.5.7| to \verb|v7.5.8| (August 30, 2024) the updates are as follows:
\noindent
\begin{itemize}
