...
(version v6.7.6, release date Dec. 10, 2015) \\
\normalsize
\end{center}
...
\noindent
In going from \verb|v6.2.8| to \verb|v6.7.6|, the updates are as follows:

\begin{itemize}
\item Faster event generation for VBF and $Hjj$ with deterministic jet flavor assignment
\item Clean up of the $VH$ code and CKM matrix
\item Add \verb|Processes=110-113| for $t/\bar{t}+H$ production
