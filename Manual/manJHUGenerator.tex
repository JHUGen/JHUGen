...
\item {\verb|OffshellX|}: The flag specifies whether the events for processes 0, 1 or 2 feature a delta-function resonance mass (when set to \verb|.false.|) at or a finite-width distribution around the resonance mass. This option replaces the \verb|OffXVV| numerical flag in previous versions.
