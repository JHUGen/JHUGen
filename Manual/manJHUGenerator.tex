...
\begin{verbatim}
  ...
  Cuts:
    ...
    mHstar_min, mHstar_max:  Minimum and maximum four-lepton mass 
...
\item \verb|pTjetcut|, \verb|etajetcut|, \verb|detajetcut|, \verb|deltaRcut|, \verb|mJJcut|, \verb|mHstar_min|, \verb|mHstar_max|, \verb|m2l_min|, \verb|m2l_max|, \verb|mVH_min|, \verb|mVH_max|, \verb|pTlepcut|, \verb|etalepcut|, and \verb|pTHcut| are available for Process 51. The default values are set such that there is no cuts.
\end{itemize}
...
\begin{table}[!ht]
  ...
  \hline
      \verb|mHstar_min| set & \verb|mHstar_max| set & \verb|BreitWignerCutoff| set & outcome\\ \hline
      ...
      True & True & False & Use user input for \verb|mHstar_min|/\verb|mHstar_max| \\ \hline
...
\item \verb|mHstar_min|, \verb|mHstar_max|: These two values, when used in conjunction, provide an upper and lower bound to the mass range.
\end{itemize}
