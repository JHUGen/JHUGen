...
(version v7.5.0, release date July 4, 2020) \\
\normalsize
\end{center}
...
\item The $Zff$ couplings $a^f_\mathrm{L,R}$ in Eq.~(\ref{eq:def:Zff}) can be modified with \verb|az_Lep_left, az_Lep_right|, \verb|az_Neu_left, az_Neu_right|, 
\verb|az_QUp_left, az_QUp_right| and \verb|az_QDn_left, az_QDn_right|.
\end{itemize}
