...
\noindent
In going to \verb|v7.3.0| (April 28, 2019), the updates are as follows:
\begin{itemize}
\item Faster option for generating interference in \(4\ell\) final states in offshell VBF production, 164 jobs per step.
\end{itemize}
\noindent
