...
the Higgs self-coupling, and to Oscar Eboli for introducing anomalous Zqq couplings, into the gluon fusion process for MCFM~\cite{SelfCoupling}.
Certain processes, such as quark-antiquark Higgs production, similarly depend on Madgraph utilizing SMEFTsim,
colloquially referred to as ``madMELA''~\cite{SMEFTsim1, SMEFTsim2}.
...
The couplings used by the Madgraph interface utilize the SMEFTsim package for Madgraph at NLO \cite{SMEFTsim1, SMEFTsim2}. These are expressed as real-valued Wilson Coefficients, and affect far more than just the amplitudes within couplings.
...
\item Fixed a sign mistake in JHUGenLexicon
\end{itemize}
\noindent
