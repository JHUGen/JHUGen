...
(version v6.7.0, release date Oct. 6, 2015) \\
\normalsize
\end{center}
...
real(8), public, parameter :: M_Top   = 173.2d0     *GeV      !
real(8), public, parameter :: Ga_Top  = 2d0    *GeV     !
...
real(8), public            :: M_Reso  = 125d0   *GeV      ! X resonance mass (spin 0, spin 1,
                                                            !  spin 2) (careful: no longer a
                                                            !  parameter, can be overwritten by
                                                            !  command line argument)
real(8), public, parameter :: Ga_Reso = 0.00407d0 *GeV      ! X resonance width
...
real(8), public, parameter :: POL_B = 0d0                   !e- polarization. 0: no polarization,
                                                                              100: helicity = 1,
                                                                              -100: helicity = -1
logical, public, parameter :: H_DK =.false.                  !default to false so H in
...
\noindent
In going from \verb|v6.2.8| to \verb|v6.7.0|, the updates are as follows:

\begin{itemize}
\item $H\to\tau\tau$ decay
\item $tqH$ production
