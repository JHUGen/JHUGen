...
The couplings used by the Madgraph interface utilize the SMEFTsim package for Madgraph at NLO \cite{SMEFTsim1} \cite{SMEFTsim2}. These are expressed as real-valued Wilson Coefficients, and affect far more than just the amplitudes within couplings.
