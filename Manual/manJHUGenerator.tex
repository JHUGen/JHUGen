...
\label{TGCQGC}
Off-shell VBF processes 66 (signal), 67 (background), and 68 (signal+background+interference) involve triple and quartic gauge couplings in Eqs.~\ref{eq:VVV}-\ref{eq:VVVV}.
To set the couplings in Eqs.~\ref{eq:VVVVSM} on the command line use e.g. 
\begin{eqnarray*}
d_1^\gamma \quad \leftrightarrow& \quad  &{\verb dVA  = 1.0,0.0 }\\
d_2^\gamma \quad \leftrightarrow& \quad  &{\verb dPA  = 1.0,0.0 }\\
d_3^\gamma \quad \leftrightarrow& \quad  &{\verb dMA  = 1.0,0.0 }\\
d_1^Z      \quad \leftrightarrow& \quad  &{\verb dVZ  = 1.0,0.0 }\\
d_2^Z      \quad \leftrightarrow& \quad  &{\verb dPZ  = 1.0,0.0 }\\
d_3^Z      \quad \leftrightarrow& \quad  &{\verb dMZ  = 1.0,0.0 }\\
d_4^\gamma \times d^{\gamma WW} \quad \leftrightarrow& \quad  &{\verb dFourA  = 1.0,0.0 }\\
d_4^Z      \times d^{Z      WW} \quad \leftrightarrow& \quad  &{\verb dFourZ  = 1.0,0.0 }\\
d^{\gamma\gamma WW}      \quad \leftrightarrow& \quad  &{\verb dAAWpWm  = 1.0,0.0 }\\
\frac{s_w}{c_w} \times d^{Z\gamma WW}      \quad \leftrightarrow& \quad  &{\verb dZAWpWm  = 1.0,0.0 }\\
\frac{s_w^2}{c_w^2} \times d^{ZZ WW}      \quad \leftrightarrow& \quad  &{\verb dZZWpWm  = 1.0,0.0 }\\
...
\item Added command line setting of triple and quartic gauge boson couplings in off-shell VBF processes 66-68.
\item Enlarge allowed invariant mass range in the $q\bar{q} \to H \gamma$ process
\end{itemize}
\noindent
