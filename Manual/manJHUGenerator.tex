...
./JHUGen Process=60 VegasNc2=100000 DataFile=gammagammaVBF ghgsgs2=1,0 \\
			pTjetcut=15 deltaRcut=0.3
\end{verbatim}
(Requires jet cuts to avoid divergences when $q_\gamma^2\to 0$.  The ones here are the default cuts, but are shown explicitly as an example.)
\end{itemize}
\item $H+jj$:
\begin{verbatim}
