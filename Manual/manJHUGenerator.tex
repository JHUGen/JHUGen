...
(version v6.8.6, release date Jan. 07, 2016, manual date Jan. 07, 2016) \\
\normalsize
\end{center}
...
\begin{itemize}
\item \verb|ghgX|, \verb|ghzX|, \verb|ghzX_primeY|, \verb|cz_qXsq|, \verb|ghwX|, \verb|ghwX_primeY|, \verb|cw_qXsq|, \verb|ghzgsX|, \verb|ghzgs1_prime2|, and \verb|ghgsgsX| for spin 0 (see the list for the ranges of X and Y)
\item \verb|zprime_qq_left|, \verb|zprime_qq_right|, \verb|zprime_zz_1|, and \verb|zprime_zz_2| for spin 1
\item \verb|aX|, \verb|bX|, \verb|graviton_qq_left|, \verb|and graviton_qq_right| (see the list for the range of X)
...
\noindent
In going from \verb|v6.8.4| to \verb|v6.8.6|, the updates are as follows:

\begin{itemize}
\item Resonance width, jet cuts, and anomalous couplings are now command line parameters
\end{itemize}
