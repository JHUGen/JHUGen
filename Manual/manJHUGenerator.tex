...
(version v7.0.0, release date Jul. 29, 2016, manual date Sep. 26, 2016) \\
\normalsize
\end{center}
...
!---parameters that define spin 1 coupling to SM fields, see note
   ...
   complex(8), public, parameter :: zprime_zz_1 =  (0.0d0,0d0)!  =1 for JP=1-
   complex(8), public, parameter :: zprime_zz_2 =  (0.0d0,0d0)!  =1 for JP=1+
\end{verbatim}
