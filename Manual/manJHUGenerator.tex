...
(version v7.5.4, release date November 6, 2023) \\
\normalsize
\end{center}
...
\begin{verbatim}
  ...
  Cuts:
    ...
    m4l_min, m4l_max:  Minimum and maximum four-lepton mass 
                       (default for on-shell: $M_{Reso}\pm20\Gamma_{Reso}$)
                       (default for off-shell: None)
...
These two cuts are on the mass range in the on-shell regime of JHUGen. The default mass cut is made at an upper and lower bound of $M_{Reso}\pm20\Gamma_{Reso}$
\begin{itemize}
