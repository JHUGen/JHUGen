...
(version v7.5.4, release date November 10, 2023) \\
\normalsize
\end{center}
...
\noindent 
In going from \verb|v7.5.3| to \verb|v7.5.4| (November 10, 2023) the updates are as follows:
\noindent
\begin{itemize}
\item Add new factorization scheme which is a uniform sampling between two given numbers
\end{itemize}
