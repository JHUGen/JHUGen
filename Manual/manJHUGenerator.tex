...
\begin{verbatim}
    ...
    ghz1, ghz2, ghz4,
          ghz1_prime2: Spin 0 anomalous couplings
...
\item Anomalous couplings: the most commonly used anomalous couplings can be set on the command line.  These are \verb|ghz1|, \verb|ghz2|, \verb|ghz4|, and \verb|ghz1_prime2| for spin 0, and \verb|a1|, \verb|a2|, \verb|b1|, \verb|b2|, and \verb|b5| for spin 2.  If any anomalous couplings are set, the default couplings (\verb|ghz1| for spin 0, \verb|a2| and \verb|b2| for spin 2) must also be explicitly turned off by setting them to 0 or explicitly turned on by setting them to nonzero values.  The couplings can be set in two ways:
\begin{itemize}
