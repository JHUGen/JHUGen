...
(version v7.0.0, release date Jul. 29, 2016, manual date Jul. 29, 2016) \\
\normalsize
\end{center}
...
\noindent
In going from \verb|v6.9.8| to \verb|v7.0.0|, the updates are as follows:

\begin{itemize}
\item Further improvements in phasespace sampling in the \verb|ReadLHE| mode.
\item Offshell photons in VBF and $VH$ production, and onshell $\gamma H$ production
\end{itemize}
