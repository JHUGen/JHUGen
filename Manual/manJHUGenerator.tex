...
(version 4.0.1, release date October 7, 2013) \\
\normalsize
\end{center}
...
For the parameters in Eq.(9) from Ref.~\cite{Bolognesi:2012}, we now allow for $q^2$ dependent form factors as described in Eq.(3) of~\cite{Anderson:2013}.
The full parameterization is given as:
\begin{verbatim}
...
generate large enough (e.g. {\tt VegasNc1=1000000}) number of weighted events
