...
character(len=*) :: title
    ...
    write(TheUnit, *) " ", CenterWithStars("L. S. Mandacaru Guerra, Z. Guo, C. Martin, T. Martini, K. Melnikov, R. Pan,", linelength)
    write(TheUnit, *) " ", CenterWithStars("R. Rontsch, H. Roskes, U. Sarica, M. Schulze, N. Tran, A. Whitbeck, M. Xiao, Y. Zhou", linelength)
