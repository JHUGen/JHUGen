...
subroutine ggboxHH4mp(mom,Spaa,Spbb,sprod,ggboxHH4)
  implicit none
  ...
  D3333 = Dcoeff(0,0,0,4)
     ...
     /(Spaa(1,2))*Spaa(1,3)**3*Spbb(1,3)*Spbb(2,3)**2*D2223 + 16d0/( &
     dsqrt(2d0))/(Spbb(1,2))/(dsqrt(2d0))/(Spaa(1,2))*Spaa(1,3)**2* &
     Spaa(1,4)*Spbb(1,3)*Spbb(2,3)*Spbb(2,4)*D2223 + 8d0/(dsqrt(2d0))/( &
     Spbb(1,2))/(dsqrt(2d0))/(Spaa(1,2))*Spaa(1,3)**2*Spaa(1,4)*Spbb(1 &
     ,4)*Spbb(2,3)**2*D2223 - 8d0/(dsqrt(2d0))/(Spbb(1,2))/(dsqrt(2d0)) &
     /(Spaa(1,2))*Spaa(1,3)**2*Spaa(2,3)*Spbb(2,3)**3*D222 - 8d0/( &
     dsqrt(2d0))/(Spbb(1,2))/(dsqrt(2d0))/(Spaa(1,2))*Spaa(1,3)**2* &
     Spaa(2,3)*Spbb(2,3)**3*D1222 - 8d0/(dsqrt(2d0))/(Spbb(1,2))/( &
     dsqrt(2d0))/(Spaa(1,2))*Spaa(1,3)**2*Spaa(2,3)*Spbb(2,3)**3*D2222 &
      - 8d0/(dsqrt(2d0))/(Spbb(1,2))/(dsqrt(2d0))/(Spaa(1,2))*Spaa(1,3) &
     **2*Spaa(2,4)*Spbb(2,3)**2*Spbb(2,4)*D222
      ggboxHH4 = ggboxHH4 - 8d0/(dsqrt(2d0))/(Spbb(1,2))/(dsqrt(2d0))/( &
     Spaa(1,2))*Spaa(1,3)**2*Spaa(2,4)*Spbb(2,3)**2*Spbb(2,4)*D1222 &
      - 8d0/(dsqrt(2d0))/(Spbb(1,2))/(dsqrt(2d0))/(Spaa(1,2))*Spaa(1,3) &
     **2*Spaa(2,4)*Spbb(2,3)**2*Spbb(2,4)*D2222 + 8d0/(dsqrt(2d0))/( &
     ...
     *Spbb(2,3)**2*D002 - 16d0/(dsqrt(2d0))/(Spbb(1,2))/(dsqrt(2d0))/( &
     ...
     ,3)*Spbb(2,4)**2*D2223 + 16d0/(dsqrt(2d0))/(Spbb(1,2))/(dsqrt(2d0)) &
     ...
     1,3)*Spaa(1,4)*Spaa(2,3)*Spbb(2,3)**2*Spbb(2,4)*D1222 - 16d0/( &
     dsqrt(2d0))/(Spbb(1,2))/(dsqrt(2d0))/(Spaa(1,2))*Spaa(1,3)*Spaa(1, &
     4)*Spaa(2,3)*Spbb(2,3)**2*Spbb(2,4)*D2222 - 16d0/(dsqrt(2d0))/( &
     ...
     *Spbb(2,3)*Spbb(2,4)**2*D222 - 16d0/(dsqrt(2d0))/(Spbb(1,2))/( &
     ...
     Spbb(2,4)**2*D1222 - 16d0/(dsqrt(2d0))/(Spbb(1,2))/(dsqrt(2d0))/( &
     ...
     *Spaa(1,4)*Spaa(3,4)*Spbb(2,3)*Spbb(2,4)*Spbb(3,4)*D2222 - 16d0/( &
     ...
     4)*Spbb(2,3)*Spbb(2,4)*D2*mloop**2
      ggboxHH4 = ggboxHH4 - 48d0/(dsqrt(2d0))/(Spbb(1,2))/(dsqrt(2d0))/( &
  ...
  return
end subroutine ggboxHH4mp

end module ModggboxHH4mp
!!--YaofuZhou-----------------------------------------