...
subroutine ggboxHH3mp(mom,Spaa,Spbb,sprod,ggboxHH3)
  implicit none
  ...
  D3333 = Dcoeff(0,0,0,4)
     ...
     Spaa(1,2)*Spaa(1,3)**2*Spbb(1,2)*Spbb(2,3)**2*D1222 - 8d0/(dsqrt( &
     2d0))/(Spbb(1,2))/(dsqrt(2d0))/(Spaa(1,2))*Spaa(1,2)*Spaa(1,3)**2* &
     Spbb(1,2)*Spbb(2,3)**2*D1223 + 8d0/(dsqrt(2d0))/(Spbb(1,2))/( &
     ...
     1,3)*Spaa(1,4)*Spbb(1,2)*Spbb(2,3)*Spbb(2,4)*D1222 - 16d0/(dsqrt( &
     2d0))/(Spbb(1,2))/(dsqrt(2d0))/(Spaa(1,2))*Spaa(1,2)*Spaa(1,3)* &
     Spaa(1,4)*Spbb(1,2)*Spbb(2,3)*Spbb(2,4)*D1223 + 4d0/(dsqrt(2d0))/( &
     ...
     Spaa(1,4)**2*Spbb(1,2)*Spbb(2,4)**2*D1222 - 8d0/(dsqrt(2d0))/( &
     Spbb(1,2))/(dsqrt(2d0))/(Spaa(1,2))*Spaa(1,2)*Spaa(1,4)**2*Spbb(1 &
     ,2)*Spbb(2,4)**2*D1223 + 8d0/(dsqrt(2d0))/(Spbb(1,2))/(dsqrt(2d0)) &
     /(Spaa(1,2))*Spaa(1,3)**3*Spbb(1,3)*Spbb(2,3)**2*D1222 + 16d0/( &
     dsqrt(2d0))/(Spbb(1,2))/(dsqrt(2d0))/(Spaa(1,2))*Spaa(1,3)**2* &
     Spaa(1,4)*Spbb(1,3)*Spbb(2,3)*Spbb(2,4)*D1222 + 8d0/(dsqrt(2d0))/( &
     Spbb(1,2))/(dsqrt(2d0))/(Spaa(1,2))*Spaa(1,3)**2*Spaa(1,4)*Spbb(1 &
     ,4)*Spbb(2,3)**2*D1222 - 8d0/(dsqrt(2d0))/(Spbb(1,2))/(dsqrt(2d0)) &
     /(Spaa(1,2))*Spaa(1,3)**2*Spaa(2,3)*Spbb(2,3)**3*D222 - 8d0/( &
     dsqrt(2d0))/(Spbb(1,2))/(dsqrt(2d0))/(Spaa(1,2))*Spaa(1,3)**2* &
     Spaa(2,3)*Spbb(2,3)**3*D2222 - 8d0/(dsqrt(2d0))/(Spbb(1,2))/( &
     dsqrt(2d0))/(Spaa(1,2))*Spaa(1,3)**2*Spaa(2,3)*Spbb(2,3)**3*D2223 &
      - 8d0/(dsqrt(2d0))/(Spbb(1,2))/(dsqrt(2d0))/(Spaa(1,2))*Spaa(1,3) &
     **2*Spaa(2,4)*Spbb(2,3)**2*Spbb(2,4)*D222
      ggboxHH3 = ggboxHH3 - 8d0/(dsqrt(2d0))/(Spbb(1,2))/(dsqrt(2d0))/( &
     Spaa(1,2))*Spaa(1,3)**2*Spaa(2,4)*Spbb(2,3)**2*Spbb(2,4)*D2222 &
      - 8d0/(dsqrt(2d0))/(Spbb(1,2))/(dsqrt(2d0))/(Spaa(1,2))*Spaa(1,3) &
     **2*Spaa(2,4)*Spbb(2,3)**2*Spbb(2,4)*D2223 + 8d0/(dsqrt(2d0))/( &
     Spbb(1,2))/(dsqrt(2d0))/(Spaa(1,2))*Spaa(1,3)**2*Spaa(3,4)*Spbb(2 &
     ,3)**2*Spbb(3,4)*D222 + 8d0/(dsqrt(2d0))/(Spbb(1,2))/(dsqrt(2d0))/( &
     Spaa(1,2))*Spaa(1,3)**2*Spaa(3,4)*Spbb(2,3)**2*Spbb(3,4)*D2222 &
      - 8d0/(dsqrt(2d0))/(Spbb(1,2))/(dsqrt(2d0))/(Spaa(1,2))*Spaa(1,3) &
     **2*Spbb(2,3)**2*D2*mloop**2 - 24d0/(dsqrt(2d0))/(Spbb(1,2))/( &
     dsqrt(2d0))/(Spaa(1,2))*Spaa(1,3)**2*Spbb(2,3)**2*D22*mloop**2 +  &
     16d0/(dsqrt(2d0))/(Spbb(1,2))/(dsqrt(2d0))/(Spaa(1,2))*Spaa(1,3)**2 &
     *Spbb(2,3)**2*D002 - 16d0/(dsqrt(2d0))/(Spbb(1,2))/(dsqrt(2d0))/( &
     Spaa(1,2))*Spaa(1,3)**2*Spbb(2,3)**2*D0022 + 8d0/(dsqrt(2d0))/( &
     Spbb(1,2))/(dsqrt(2d0))/(Spaa(1,2))*Spaa(1,3)*Spaa(1,4)**2*Spbb(1 &
     ,3)*Spbb(2,4)**2*D1222 + 16d0/(dsqrt(2d0))/(Spbb(1,2))/(dsqrt(2d0)) &
     /(Spaa(1,2))*Spaa(1,3)*Spaa(1,4)**2*Spbb(1,4)*Spbb(2,3)*Spbb(2,4 &
     )*D1222
      ggboxHH3 = ggboxHH3 - 16d0/(dsqrt(2d0))/(Spbb(1,2))/(dsqrt(2d0))/( &
     Spaa(1,2))*Spaa(1,3)*Spaa(1,4)*Spaa(2,3)*Spbb(2,3)**2*Spbb(2,4)* &
     D222 - 16d0/(dsqrt(2d0))/(Spbb(1,2))/(dsqrt(2d0))/(Spaa(1,2))*Spaa( &
     1,3)*Spaa(1,4)*Spaa(2,3)*Spbb(2,3)**2*Spbb(2,4)*D2222 - 16d0/( &
     dsqrt(2d0))/(Spbb(1,2))/(dsqrt(2d0))/(Spaa(1,2))*Spaa(1,3)*Spaa(1, &
     4)*Spaa(2,3)*Spbb(2,3)**2*Spbb(2,4)*D2223 - 16d0/(dsqrt(2d0))/( &
     Spbb(1,2))/(dsqrt(2d0))/(Spaa(1,2))*Spaa(1,3)*Spaa(1,4)*Spaa(2,4) &
     *Spbb(2,3)*Spbb(2,4)**2*D222 - 16d0/(dsqrt(2d0))/(Spbb(1,2))/( &
     dsqrt(2d0))/(Spaa(1,2))*Spaa(1,3)*Spaa(1,4)*Spaa(2,4)*Spbb(2,3)* &
     Spbb(2,4)**2*D2222 - 16d0/(dsqrt(2d0))/(Spbb(1,2))/(dsqrt(2d0))/( &
     Spaa(1,2))*Spaa(1,3)*Spaa(1,4)*Spaa(2,4)*Spbb(2,3)*Spbb(2,4)**2* &
     D2223 + 16d0/(dsqrt(2d0))/(Spbb(1,2))/(dsqrt(2d0))/(Spaa(1,2))* &
     Spaa(1,3)*Spaa(1,4)*Spaa(3,4)*Spbb(2,3)*Spbb(2,4)*Spbb(3,4)*D222 &
      + 16d0/(dsqrt(2d0))/(Spbb(1,2))/(dsqrt(2d0))/(Spaa(1,2))*Spaa(1,3) &
     *Spaa(1,4)*Spaa(3,4)*Spbb(2,3)*Spbb(2,4)*Spbb(3,4)*D2222 - 16d0/( &
     dsqrt(2d0))/(Spbb(1,2))/(dsqrt(2d0))/(Spaa(1,2))*Spaa(1,3)*Spaa(1, &
     4)*Spbb(2,3)*Spbb(2,4)*D2*mloop**2
      ggboxHH3 = ggboxHH3 - 48d0/(dsqrt(2d0))/(Spbb(1,2))/(dsqrt(2d0))/( &
     Spaa(1,2))*Spaa(1,3)*Spaa(1,4)*Spbb(2,3)*Spbb(2,4)*D22*mloop**2 &
      + 32d0/(dsqrt(2d0))/(Spbb(1,2))/(dsqrt(2d0))/(Spaa(1,2))*Spaa(1,3) &
     *Spaa(1,4)*Spbb(2,3)*Spbb(2,4)*D002 - 32d0/(dsqrt(2d0))/(Spbb(1,2) &
     )/(dsqrt(2d0))/(Spaa(1,2))*Spaa(1,3)*Spaa(1,4)*Spbb(2,3)*Spbb(2,4 &
     )*D0022 + 8d0/(dsqrt(2d0))/(Spbb(1,2))/(dsqrt(2d0))/(Spaa(1,2))* &
     ...
     Spaa(1,2))*Spaa(1,4)**2*Spaa(2,3)*Spbb(2,3)*Spbb(2,4)**2*D2222 &
      - 8d0/(dsqrt(2d0))/(Spbb(1,2))/(dsqrt(2d0))/(Spaa(1,2))*Spaa(1,4) &
     **2*Spaa(2,3)*Spbb(2,3)*Spbb(2,4)**2*D2223 - 8d0/(dsqrt(2d0))/( &
     Spbb(1,2))/(dsqrt(2d0))/(Spaa(1,2))*Spaa(1,4)**2*Spaa(2,4)*Spbb(2 &
     ,4)**3*D222 - 8d0/(dsqrt(2d0))/(Spbb(1,2))/(dsqrt(2d0))/(Spaa(1,2)) &
     *Spaa(1,4)**2*Spaa(2,4)*Spbb(2,4)**3*D2222 - 8d0/(dsqrt(2d0))/( &
     Spbb(1,2))/(dsqrt(2d0))/(Spaa(1,2))*Spaa(1,4)**2*Spaa(2,4)*Spbb(2 &
     ,4)**3*D2223
      ggboxHH3 = ggboxHH3 + 8d0/(dsqrt(2d0))/(Spbb(1,2))/(dsqrt(2d0))/( &
     Spaa(1,2))*Spaa(1,4)**2*Spaa(3,4)*Spbb(2,4)**2*Spbb(3,4)*D222 +  &
     8d0/(dsqrt(2d0))/(Spbb(1,2))/(dsqrt(2d0))/(Spaa(1,2))*Spaa(1,4)**2* &
     Spaa(3,4)*Spbb(2,4)**2*Spbb(3,4)*D2222 - 8d0/(dsqrt(2d0))/(Spbb(1, &
     2))/(dsqrt(2d0))/(Spaa(1,2))*Spaa(1,4)**2*Spbb(2,4)**2*D2* &
     mloop**2 - 24d0/(dsqrt(2d0))/(Spbb(1,2))/(dsqrt(2d0))/(Spaa(1,2))* &
     Spaa(1,4)**2*Spbb(2,4)**2*D22*mloop**2 + 16d0/(dsqrt(2d0))/(Spbb(1 &
     ,2))/(dsqrt(2d0))/(Spaa(1,2))*Spaa(1,4)**2*Spbb(2,4)**2*D002 - 16d0 &
     /(dsqrt(2d0))/(Spbb(1,2))/(dsqrt(2d0))/(Spaa(1,2))*Spaa(1,4)**2* &
     Spbb(2,4)**2*D0022
  
  return
end subroutine ggboxHH3mp

end module ModggboxHH3mp
!!--YaofuZhou-----------------------------------------