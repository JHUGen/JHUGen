...
subroutine ggboxHH6mp(mom,Spaa,Spbb,sprod,ggboxHH6)
  implicit none
  ...
  D3333 = Dcoeff(0,0,0,4)
     ...
     *D2*mloop**2 - 32d0/(dsqrt(2d0))/(Spbb(1,2))/(dsqrt(2d0))/(Spaa(1,2 &
     ))*Spaa(1,3)**2*Spbb(2,3)**2*D3*mloop**2 + 16d0/(dsqrt(2d0))/( &
     Spbb(1,2))/(dsqrt(2d0))/(Spaa(1,2))*Spaa(1,3)**2*Spbb(2,3)**2*D00
      ggboxHH6 = ggboxHH6 - 32d0/(dsqrt(2d0))/(Spbb(1,2))/(dsqrt(2d0))/( &
     Spaa(1,2))*Spaa(1,3)**2*Spbb(2,3)**2*D22*mloop**2 - 32d0/(dsqrt( &
     2d0))/(Spbb(1,2))/(dsqrt(2d0))/(Spaa(1,2))*Spaa(1,3)**2*Spbb(2,3) &
     **2*D33*mloop**2 - 64d0/(dsqrt(2d0))/(Spbb(1,2))/(dsqrt(2d0))/( &
     Spaa(1,2))*Spaa(1,3)**2*Spbb(2,3)**2*D23*mloop**2 - 16d0/(dsqrt( &
     ...
     D2*mloop**2 - 64d0/(dsqrt(2d0))/(Spbb(1,2))/(dsqrt(2d0))/(Spaa(1,2) &
     )*Spaa(1,3)*Spaa(1,4)*Spbb(2,3)*Spbb(2,4)*D3*mloop**2 + 32d0/( &
     dsqrt(2d0))/(Spbb(1,2))/(dsqrt(2d0))/(Spaa(1,2))*Spaa(1,3)*Spaa(1, &
     4)*Spbb(2,3)*Spbb(2,4)*D00 - 64d0/(dsqrt(2d0))/(Spbb(1,2))/(dsqrt( &
     2d0))/(Spaa(1,2))*Spaa(1,3)*Spaa(1,4)*Spbb(2,3)*Spbb(2,4)*D22* &
     mloop**2 - 64d0/(dsqrt(2d0))/(Spbb(1,2))/(dsqrt(2d0))/(Spaa(1,2))* &
     Spaa(1,3)*Spaa(1,4)*Spbb(2,3)*Spbb(2,4)*D33*mloop**2 - 128d0/( &
     dsqrt(2d0))/(Spbb(1,2))/(dsqrt(2d0))/(Spaa(1,2))*Spaa(1,3)*Spaa(1, &
     4)*Spbb(2,3)*Spbb(2,4)*D23*mloop**2
      ggboxHH6 = ggboxHH6 - 8d0/(dsqrt(2d0))/(Spbb(1,2))/(dsqrt(2d0))/( &
     Spaa(1,2))*Spaa(1,4)**2*Spbb(2,4)**2*D0*mloop**2 - 32d0/(dsqrt(2d0 &
     ))/(Spbb(1,2))/(dsqrt(2d0))/(Spaa(1,2))*Spaa(1,4)**2*Spbb(2,4)**2 &
     *D2*mloop**2 - 32d0/(dsqrt(2d0))/(Spbb(1,2))/(dsqrt(2d0))/(Spaa(1,2 &
     ))*Spaa(1,4)**2*Spbb(2,4)**2*D3*mloop**2 + 16d0/(dsqrt(2d0))/( &
     Spbb(1,2))/(dsqrt(2d0))/(Spaa(1,2))*Spaa(1,4)**2*Spbb(2,4)**2*D00 &
      - 32d0/(dsqrt(2d0))/(Spbb(1,2))/(dsqrt(2d0))/(Spaa(1,2))*Spaa(1,4) &
     **2*Spbb(2,4)**2*D22*mloop**2 - 32d0/(dsqrt(2d0))/(Spbb(1,2))/( &
     dsqrt(2d0))/(Spaa(1,2))*Spaa(1,4)**2*Spbb(2,4)**2*D33*mloop**2 -  &
     64d0/(dsqrt(2d0))/(Spbb(1,2))/(dsqrt(2d0))/(Spaa(1,2))*Spaa(1,4)**2 &
     *Spbb(2,4)**2*D23*mloop**2
  
  return
end subroutine ggboxHH6mp

end module ModggboxHH6mp
!!--YaofuZhou-----------------------------------------