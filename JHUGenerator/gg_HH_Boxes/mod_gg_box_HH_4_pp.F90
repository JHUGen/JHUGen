...
subroutine ggboxHH4pp(mom,Spaa,Spbb,sprod,ggboxHH4)
  implicit none
  ...
  D3333 = Dcoeff(0,0,0,4)
     ...
     Spbb(1,3)*D23
      ggboxHH4 = ggboxHH4 - 8d0/(dsqrt(2d0))/(Spaa(1,2))/(dsqrt(2d0))/( &
     ...
     *Spbb(1,3)*D2233 - 4d0/(dsqrt(2d0))/(Spaa(1,2))/(dsqrt(2d0))/(Spaa( &
     ...
     Spbb(2,3)*D23
      ggboxHH4 = ggboxHH4 + 24d0/(dsqrt(2d0))/(Spaa(1,2))/(dsqrt(2d0))/( &
     ...
     *Spbb(2,3)*D2223
     ...
     Spbb(2,4)*D221
      ggboxHH4 = ggboxHH4 + 20d0/(dsqrt(2d0))/(Spaa(1,2))/(dsqrt(2d0))/( &
     ...
     *Spbb(3,4)*D22 - 8d0/(dsqrt(2d0))/(Spaa(1,2))/(dsqrt(2d0))/(Spaa(1, &
     ...
     Spbb(3,4)*D221
      ggboxHH4 = ggboxHH4 - 16d0/(dsqrt(2d0))/(Spaa(1,2))/(dsqrt(2d0))/( &
     ...
     *Spaa(3,4)*Spbb(1,2)**2*Spbb(3,4)*D1223 - 16d0/(dsqrt(2d0))/(Spaa( &
     ...
     2*Spbb(3,4)*D2223 - 8d0/(dsqrt(2d0))/(Spaa(1,2))/(dsqrt(2d0))/( &
     ...
     *Spaa(1,2)**2*Spbb(1,2)**2*D2*mloop**2 - 8d0/(dsqrt(2d0))/(Spaa(1, &
     ...
     Spbb(1,4)*D2233 - 4d0/(dsqrt(2d0))/(Spaa(1,2))/(dsqrt(2d0))/(Spaa(1 &
     ...
     *D222 - 4d0/(dsqrt(2d0))/(Spaa(1,2))/(dsqrt(2d0))/(Spaa(1,2))*Spaa( &
     ...
     3)*Spbb(1,2)*Spbb(1,3)*Spbb(2,3)*D2223 - 4d0/(dsqrt(2d0))/(Spaa(1, &
     2))/(dsqrt(2d0))/(Spaa(1,2))*Spaa(1,2)*Spaa(1,3)*Spaa(2,4)*Spbb(1 &
     ,2)*Spbb(1,3)*Spbb(2,4)*D2 - 4d0/(dsqrt(2d0))/(Spaa(1,2))/(dsqrt( &
     2d0))/(Spaa(1,2))*Spaa(1,2)*Spaa(1,3)*Spaa(2,4)*Spbb(1,2)*Spbb(1, &
     3)*Spbb(2,4)*D22
      ggboxHH4 = ggboxHH4 - 4d0/(dsqrt(2d0))/(Spaa(1,2))/(dsqrt(2d0))/( &
     ...
     /(Spaa(1,2))/(dsqrt(2d0))/(Spaa(1,2))*Spaa(1,2)*Spaa(1,3)*Spaa(2, &
     4)*Spbb(1,2)*Spbb(1,3)*Spbb(2,4)*D221 - 16d0/(dsqrt(2d0))/(Spaa(1, &
     2))/(dsqrt(2d0))/(Spaa(1,2))*Spaa(1,2)*Spaa(1,3)*Spaa(2,4)*Spbb(1 &
     ,2)*Spbb(1,3)*Spbb(2,4)*D223 - 16d0/(dsqrt(2d0))/(Spaa(1,2))/( &
     dsqrt(2d0))/(Spaa(1,2))*Spaa(1,2)*Spaa(1,3)*Spaa(2,4)*Spbb(1,2)* &
     Spbb(1,3)*Spbb(2,4)*D1223 - 16d0/(dsqrt(2d0))/(Spaa(1,2))/(dsqrt( &
     2d0))/(Spaa(1,2))*Spaa(1,2)*Spaa(1,3)*Spaa(2,4)*Spbb(1,2)*Spbb(1, &
     3)*Spbb(2,4)*D2223
      ggboxHH4 = ggboxHH4 + 4d0/(dsqrt(2d0))/(Spaa(1,2))/(dsqrt(2d0))/( &
     ...
     2)*Spbb(1,4)*Spbb(2,3)*D1223 - 8d0/(dsqrt(2d0))/(Spaa(1,2))/( &
     dsqrt(2d0))/(Spaa(1,2))*Spaa(1,2)*Spaa(1,3)*Spaa(2,4)*Spbb(1,2)* &
     Spbb(1,4)*Spbb(2,3)*D2223 + 4d0/(dsqrt(2d0))/(Spaa(1,2))/(dsqrt(2d0 &
     ...
     *D223 + 16d0/(dsqrt(2d0))/(Spaa(1,2))/(dsqrt(2d0))/(Spaa(1,2))* &
     ...
     2)*Spbb(1,3)*D2*mloop**2 + 4d0/(dsqrt(2d0))/(Spaa(1,2))/(dsqrt(2d0) &
     )/(Spaa(1,2))*Spaa(1,2)*Spaa(1,3)*Spbb(1,2)*Spbb(1,3)*D3* &
     ...
     *Spbb(1,3)*D002 - 8d0/(dsqrt(2d0))/(Spaa(1,2))/(dsqrt(2d0))/(Spaa(1 &
     ,2))*Spaa(1,2)*Spaa(1,3)*Spbb(1,2)*Spbb(1,3)*D003
      ggboxHH4 = ggboxHH4 - 32d0/(dsqrt(2d0))/(Spaa(1,2))/(dsqrt(2d0))/( &
     Spaa(1,2))*Spaa(1,2)*Spaa(1,3)*Spbb(1,2)*Spbb(1,3)*D0023 + 4d0/( &
     dsqrt(2d0))/(Spaa(1,2))/(dsqrt(2d0))/(Spaa(1,2))*Spaa(1,2)*Spaa(1, &
     4)**2*Spbb(1,2)*Spbb(1,4)**2*D23 + 4d0/(dsqrt(2d0))/(Spaa(1,2))/( &
     ...
     Spbb(1,2)*Spbb(1,4)**2*D2233 + 4d0/(dsqrt(2d0))/(Spaa(1,2))/( &
     ...
     *Spbb(2,3)*D23 - 8d0/(dsqrt(2d0))/(Spaa(1,2))/(dsqrt(2d0))/(Spaa(1, &
     ...
     D123
      ggboxHH4 = ggboxHH4 - 4d0/(dsqrt(2d0))/(Spaa(1,2))/(dsqrt(2d0))/( &
     Spaa(1,2))*Spaa(1,2)*Spaa(1,4)*Spaa(2,3)*Spbb(1,2)*Spbb(1,4)* &
     Spbb(2,3)*D222 - 4d0/(dsqrt(2d0))/(Spaa(1,2))/(dsqrt(2d0))/(Spaa(1, &
     2))*Spaa(1,2)*Spaa(1,4)*Spaa(2,3)*Spbb(1,2)*Spbb(1,4)*Spbb(2,3)* &
     ...
     *Spbb(1,4)*Spbb(2,4)*D221 - 16d0/(dsqrt(2d0))/(Spaa(1,2))/(dsqrt( &
     ...
     ,4)*Spbb(1,2)*Spbb(1,4)*Spbb(3,4)*D2223 + 4d0/(dsqrt(2d0))/(Spaa(1 &
     ...
     4)*Spbb(1,2)*Spbb(1,4)*D3*mloop**2
      ggboxHH4 = ggboxHH4 - 8d0/(dsqrt(2d0))/(Spaa(1,2))/(dsqrt(2d0))/( &
     Spaa(1,2))*Spaa(1,2)*Spaa(1,4)*Spbb(1,2)*Spbb(1,4)*D00 - 24d0/( &
     dsqrt(2d0))/(Spaa(1,2))/(dsqrt(2d0))/(Spaa(1,2))*Spaa(1,2)*Spaa(1, &
     ...
     Spaa(1,4)*Spbb(1,2)*Spbb(1,4)*D0023 + 4d0/(dsqrt(2d0))/(Spaa(1,2)) &
     /(dsqrt(2d0))/(Spaa(1,2))*Spaa(1,2)*Spaa(2,3)**2*Spbb(1,2)*Spbb(2 &
     ,3)**2*D22 + 4d0/(dsqrt(2d0))/(Spaa(1,2))/(dsqrt(2d0))/(Spaa(1,2))* &
     Spaa(1,2)*Spaa(2,3)**2*Spbb(1,2)*Spbb(2,3)**2*D12 + 12d0/(dsqrt( &
     2d0))/(Spaa(1,2))/(dsqrt(2d0))/(Spaa(1,2))*Spaa(1,2)*Spaa(2,3)**2* &
     Spbb(1,2)*Spbb(2,3)**2*D222 + 4d0/(dsqrt(2d0))/(Spaa(1,2))/(dsqrt( &
     2d0))/(Spaa(1,2))*Spaa(1,2)*Spaa(2,3)**2*Spbb(1,2)*Spbb(2,3)**2* &
     ...
     ,2)*Spbb(2,3)**2*D1122
      ggboxHH4 = ggboxHH4 + 16d0/(dsqrt(2d0))/(Spaa(1,2))/(dsqrt(2d0))/( &
     Spaa(1,2))*Spaa(1,2)*Spaa(2,3)**2*Spbb(1,2)*Spbb(2,3)**2*D1222 &
     ...
     *Spbb(2,3)*Spbb(2,4)*D12 + 24d0/(dsqrt(2d0))/(Spaa(1,2))/(dsqrt(2d0 &
     ))/(Spaa(1,2))*Spaa(1,2)*Spaa(2,3)*Spaa(2,4)*Spbb(1,2)*Spbb(2,3) &
     *Spbb(2,4)*D222 + 8d0/(dsqrt(2d0))/(Spaa(1,2))/(dsqrt(2d0))/(Spaa(1 &
     ,2))*Spaa(1,2)*Spaa(2,3)*Spaa(2,4)*Spbb(1,2)*Spbb(2,3)*Spbb(2,4) &
     *D112 + 32d0/(dsqrt(2d0))/(Spaa(1,2))/(dsqrt(2d0))/(Spaa(1,2))* &
     ...
     *Spaa(2,3)*Spaa(2,4)*Spbb(1,2)*Spbb(2,3)*Spbb(2,4)*D1122 + 32d0/( &
     ...
     3)*Spaa(2,4)*Spbb(1,2)*Spbb(2,3)*Spbb(2,4)*D1222
      ggboxHH4 = ggboxHH4 + 16d0/(dsqrt(2d0))/(Spaa(1,2))/(dsqrt(2d0))/( &
     Spaa(1,2))*Spaa(1,2)*Spaa(2,3)*Spaa(2,4)*Spbb(1,2)*Spbb(2,3)* &
     Spbb(2,4)*D2222 - 4d0/(dsqrt(2d0))/(Spaa(1,2))/(dsqrt(2d0))/(Spaa(1 &
     ...
     *D22 - 20d0/(dsqrt(2d0))/(Spaa(1,2))/(dsqrt(2d0))/(Spaa(1,2))*Spaa( &
     ...
     4)*Spbb(1,2)*Spbb(2,3)*Spbb(3,4)*D2222 - 4d0/(dsqrt(2d0))/(Spaa(1, &
     2))/(dsqrt(2d0))/(Spaa(1,2))*Spaa(1,2)*Spaa(2,3)*Spbb(1,2)*Spbb(2 &
     ,3)*D0*mloop**2 - 4d0/(dsqrt(2d0))/(Spaa(1,2))/(dsqrt(2d0))/(Spaa(1 &
     ,2))*Spaa(1,2)*Spaa(2,3)*Spbb(1,2)*Spbb(2,3)*D1*mloop**2 - 12d0/( &
     dsqrt(2d0))/(Spaa(1,2))/(dsqrt(2d0))/(Spaa(1,2))*Spaa(1,2)*Spaa(2, &
     3)*Spbb(1,2)*Spbb(2,3)*D2*mloop**2
      ggboxHH4 = ggboxHH4 + 8d0/(dsqrt(2d0))/(Spaa(1,2))/(dsqrt(2d0))/( &
     Spaa(1,2))*Spaa(1,2)*Spaa(2,3)*Spbb(1,2)*Spbb(2,3)*D00 + 8d0/( &
     dsqrt(2d0))/(Spaa(1,2))/(dsqrt(2d0))/(Spaa(1,2))*Spaa(1,2)*Spaa(2, &
     3)*Spbb(1,2)*Spbb(2,3)*D001 + 40d0/(dsqrt(2d0))/(Spaa(1,2))/( &
     ...
     *Spbb(2,3)*D0022 + 4d0/(dsqrt(2d0))/(Spaa(1,2))/(dsqrt(2d0))/(Spaa( &
     1,2))*Spaa(1,2)*Spaa(2,4)**2*Spbb(1,2)*Spbb(2,4)**2*D22 + 4d0/( &
     dsqrt(2d0))/(Spaa(1,2))/(dsqrt(2d0))/(Spaa(1,2))*Spaa(1,2)*Spaa(2, &
     4)**2*Spbb(1,2)*Spbb(2,4)**2*D12 + 12d0/(dsqrt(2d0))/(Spaa(1,2))/( &
     dsqrt(2d0))/(Spaa(1,2))*Spaa(1,2)*Spaa(2,4)**2*Spbb(1,2)*Spbb(2,4 &
     )**2*D222 + 4d0/(dsqrt(2d0))/(Spaa(1,2))/(dsqrt(2d0))/(Spaa(1,2))* &
     ...
     *Spaa(2,4)**2*Spbb(1,2)*Spbb(2,4)**2*D1222 + 8d0/(dsqrt(2d0))/( &
     ...
     ,2)*Spbb(2,4)**2*D2222 - 4d0/(dsqrt(2d0))/(Spaa(1,2))/(dsqrt(2d0)) &
     ...
     *Spbb(2,4)*D0*mloop**2
      ggboxHH4 = ggboxHH4 - 4d0/(dsqrt(2d0))/(Spaa(1,2))/(dsqrt(2d0))/( &
     Spaa(1,2))*Spaa(1,2)*Spaa(2,4)*Spbb(1,2)*Spbb(2,4)*D1*mloop**2 &
      - 12d0/(dsqrt(2d0))/(Spaa(1,2))/(dsqrt(2d0))/(Spaa(1,2))*Spaa(1,2) &
     *Spaa(2,4)*Spbb(1,2)*Spbb(2,4)*D2*mloop**2 + 8d0/(dsqrt(2d0))/( &
     Spaa(1,2))/(dsqrt(2d0))/(Spaa(1,2))*Spaa(1,2)*Spaa(2,4)*Spbb(1,2) &
     *Spbb(2,4)*D00 + 8d0/(dsqrt(2d0))/(Spaa(1,2))/(dsqrt(2d0))/(Spaa(1, &
     ...
     2,3)*D2223 + 8d0/(dsqrt(2d0))/(Spaa(1,2))/(dsqrt(2d0))/(Spaa(1,2))* &
     ...
     *Spbb(1,3)*Spbb(2,4)**2*D222 - 8d0/(dsqrt(2d0))/(Spaa(1,2))/( &
     ...
     Spbb(2,4)**2*D1222 - 8d0/(dsqrt(2d0))/(Spaa(1,2))/(dsqrt(2d0))/( &
  ...
  return
end subroutine ggboxHH4pp

end module ModggboxHH4pp
!!--YaofuZhou-----------------------------------------