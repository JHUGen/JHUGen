...
! gg > ZH
    ...
    call ReadCommandLineArgument(arg, "enable_gg2qq", success, enable_gg2qq)  !undocumented, in development
! gg > ZH
    ...
    call ReadCommandLineArgument(arg, "m2l_min", success, m2l_minmax(1), SetLastArgument)   !undocumented, for internal testing
    if( SetLastArgument ) m2l_minmax(1) = m2l_minmax(1)*GeV
    call ReadCommandLineArgument(arg, "m2l_max", success, m2l_minmax(2), SetLastArgument)   !undocumented, for internal testing
    if( SetLastArgument ) m2l_minmax(2) = m2l_minmax(2)*GeV
    call ReadCommandLineArgument(arg, "mVH_min", success, mVH_minmax(1), SetLastArgument)   !undocumented, for internal testing
    if( SetLastArgument ) mVH_minmax(1) = mVH_minmax(1)*GeV
    call ReadCommandLineArgument(arg, "mVH_max", success, mVH_minmax(2), SetLastArgument)   !undocumented, for internal testing
    if( SetLastArgument ) mVH_minmax(2) = mVH_minmax(2)*GeV
    ...
    call ReadCommandLineArgument(arg, "pTHcut", success, pTHcut, SetLastArgument)
    if( SetLastArgument ) pTHcut = pTHcut*GeV
    call ReadCommandLineArgument(arg, "etalepcut", success, etalepcut, SetLastArgument)
    if( SetLastArgument ) etalepcut = etalepcut
    call ReadCommandLineArgument(arg, "etajetcut", success, etajetcut, SetLastArgument)
    if( SetLastArgument ) etajetcut = etajetcut
...
integer :: AllocStatus,NHisto
          ...
          Histo(1)%Info   = "m(jj)"
          Histo(1)%NBins  = 80
          Histo(1)%BinSize= 10d0*Ga_Reso/80d0
          Histo(1)%LowVal = m_Reso-5d0*Ga_Reso
          Histo(1)%SetScale= 1d0/GeV

          Histo(2)%Info   = "m(ll)"
          Histo(2)%NBins  = 80
          Histo(2)%BinSize= 10d0*Ga_V/80d0
          Histo(2)%LowVal = m_V-5d0*Ga_V
          Histo(2)%SetScale= 1d0/GeV
          ...
          Histo(6)%Info   = "costheta1" ! scattering angle of Z in resonance rest frame
          Histo(6)%NBins  = 80
          ...
          Histo(10)%Info   = "EHat"
          Histo(10)%NBins  = 80
          Histo(10)%BinSize= 1000d0/80d0*GeV
...
integer :: AllocStatus,NHisto
          ...
          Histo(3)%Info   = "pt(V)"
          Histo(3)%NBins  = 80
          Histo(3)%BinSize= 500d0*GeV/80d0
          Histo(3)%LowVal = 0d0*GeV
          Histo(3)%SetScale= 1d0/GeV

          Histo(4)%Info   = "pt(H)"
          Histo(4)%NBins  = 80
          Histo(4)%BinSize= 500d0*GeV/80d0
          Histo(4)%LowVal = 0d0*GeV
          Histo(4)%SetScale= 1d0/GeV
          ...
          Histo(10)%Info   = "Dgg2qq"
          Histo(10)%NBins  = 80
          Histo(10)%BinSize= 1d0/80d0
          Histo(10)%LowVal = 0d0
          Histo(10)%SetScale= 1d0
...
=======
>>>>>>> 3efa330f2eca42dcb07a4ea1add4d3661c19035e
        if( Process.eq.50 .or. Process.eq.51 .or. Process.eq.60 .or. Process.eq.61 .or. (Process.ge.66 .and. Process.le.69) .or. Process.eq.80 .or. Process.eq.90) then
