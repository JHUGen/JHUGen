...
subroutine qqbffbHa1(Spaa,Spbb,sprod,id,helicity,qqffbHa1)
  ...
  if(helicity(1).lt.0d0)then!g is -
    if(id(2)*helicity(2).lt.0d0)then!J1 is left
      if(id(6)*helicity(6).lt.0d0)then!J2 is left
        qqffbHa1 =-4d0/(dsqrt(2d0))/(Spbb(1,2))/(Spaa(1,5)*Spbb(1,5))*Spaa(1,3)*Spaa(1,5)*Spbb(1,2)*Spbb(2,4) &
                 + 4d0/(dsqrt(2d0))/(Spbb(1,2))/(Spaa(1,5)*Spbb(1,5))*Spaa(1,5)*Spaa(3,5)*Spbb(2,4)*Spbb(2,5)!-LL
      else!J2 is right
        qqffbHa1 =-4d0/(dsqrt(2d0))/(Spbb(1,2))/(Spaa(1,5)*Spbb(1,5))*Spaa(1,4)*Spaa(1,5)*Spbb(1,2)*Spbb(2,3) &
                 + 4d0/(dsqrt(2d0))/(Spbb(1,2))/(Spaa(1,5)*Spbb(1,5))*Spaa(1,5)*Spaa(4,5)*Spbb(2,3)*Spbb(2,5)!-LR
      endif
    else!J1 is right
      if(id(6)*helicity(6).lt.0d0)then!J2 is left
        qqffbHa1 =-2d0/(dsqrt(2d0))/(Spbb(1,2))/(Spaa(1,2)*Spbb(1,2))*Spaa(1,2)**2*Spaa(1,3)*Spbb(1,2)*Spbb(1,4)*Spbb(2,5)*m_Z**-2 &
                  -2d0/(dsqrt(2d0))/(Spbb(1,2))/(Spaa(1,2)*Spbb(1,2))*Spaa(1,2)**2*Spaa(2,3)*Spbb(1,2)*Spbb(2,4)*Spbb(2,5)*m_Z**-2 &
                 + 2d0/(dsqrt(2d0))/(Spbb(1,2))/(Spaa(1,2)*Spbb(1,2))*Spaa(1,2)**2*Spaa(3,5)*Spbb(1,2)*Spbb(2,5)*Spbb(4,5)*m_Z**-2 &
                  -4d0/(dsqrt(2d0))/(Spbb(1,2))/(Spaa(1,2)*Spbb(1,2))*Spaa(1,2)*Spaa(1,3)*Spbb(1,2)*Spbb(4,5) &
                  -2d0/(dsqrt(2d0))/(Spbb(1,2))/(Spaa(1,5)*Spbb(1,5))*Spaa(1,2)*Spaa(1,3)*Spaa(1,5)*Spbb(1,4)*Spbb(1,5)*Spbb(2,5)*m_Z**-2 &
                  -2d0/(dsqrt(2d0))/(Spbb(1,2))/(Spaa(1,5)*Spbb(1,5))*Spaa(1,2)*Spaa(1,5)*Spaa(2,3)*Spbb(1,5)*Spbb(2,4)*Spbb(2,5)*m_Z**-2 &
                 + 2d0/(dsqrt(2d0))/(Spbb(1,2))/(Spaa(1,5)*Spbb(1,5))*Spaa(1,2)*Spaa(1,5)*Spaa(3,5)*Spbb(1,5)*Spbb(2,5)*Spbb(4,5)*m_Z**-2 &
                 + 4d0/(dsqrt(2d0))/(Spbb(1,2))/(Spaa(1,5)*Spbb(1,5))*Spaa(1,5)*Spaa(2,3)*Spbb(2,5)*Spbb(4,5)!-RL
      else!J2 is right
        qqffbHa1 =-2d0/(dsqrt(2d0))/(Spbb(1,2))/(Spaa(1,2)*Spbb(1,2))*Spaa(1,2)**2*Spaa(1,4)*Spbb(1,2)*Spbb(1,3)*Spbb(2,5)*m_Z**-2 &
                  -2d0/(dsqrt(2d0))/(Spbb(1,2))/(Spaa(1,2)*Spbb(1,2))*Spaa(1,2)**2*Spaa(2,4)*Spbb(1,2)*Spbb(2,3)*Spbb(2,5)*m_Z**-2 &
                 + 2d0/(dsqrt(2d0))/(Spbb(1,2))/(Spaa(1,2)*Spbb(1,2))*Spaa(1,2)**2*Spaa(4,5)*Spbb(1,2)*Spbb(2,5)*Spbb(3,5)*m_Z**-2 &
                  -4d0/(dsqrt(2d0))/(Spbb(1,2))/(Spaa(1,2)*Spbb(1,2))*Spaa(1,2)*Spaa(1,4)*Spbb(1,2)*Spbb(3,5) &
                  -2d0/(dsqrt(2d0))/(Spbb(1,2))/(Spaa(1,5)*Spbb(1,5))*Spaa(1,2)*Spaa(1,4)*Spaa(1,5)*Spbb(1,3)*Spbb(1,5)*Spbb(2,5)*m_Z**-2 &
                  -2d0/(dsqrt(2d0))/(Spbb(1,2))/(Spaa(1,5)*Spbb(1,5))*Spaa(1,2)*Spaa(1,5)*Spaa(2,4)*Spbb(1,5)*Spbb(2,3)*Spbb(2,5)*m_Z**-2 &
                 + 2d0/(dsqrt(2d0))/(Spbb(1,2))/(Spaa(1,5)*Spbb(1,5))*Spaa(1,2)*Spaa(1,5)*Spaa(4,5)*Spbb(1,5)*Spbb(2,5)*Spbb(3,5)*m_Z**-2 &
                 + 4d0/(dsqrt(2d0))/(Spbb(1,2))/(Spaa(1,5)*Spbb(1,5))*Spaa(1,5)*Spaa(2,4)*Spbb(2,5)*Spbb(3,5)!-RR
      endif
    endif
  else!g is +
    if(id(2)*helicity(2).lt.0d0)then!J1 is left
      if(id(6)*helicity(6).lt.0d0)then!J2 is left
        qqffbHa1 =-2d0/(dsqrt(2d0))/(Spaa(1,2))/(Spaa(1,2)*Spbb(1,2))*Spaa(1,2)*Spaa(1,3)*Spaa(2,5)*Spbb(1,2)**2*Spbb(1,4)*m_Z**-2 &
                  -2d0/(dsqrt(2d0))/(Spaa(1,2))/(Spaa(1,2)*Spbb(1,2))*Spaa(1,2)*Spaa(2,3)*Spaa(2,5)*Spbb(1,2)**2*Spbb(2,4)*m_Z**-2 &
                 + 2d0/(dsqrt(2d0))/(Spaa(1,2))/(Spaa(1,2)*Spbb(1,2))*Spaa(1,2)*Spaa(2,5)*Spaa(3,5)*Spbb(1,2)**2*Spbb(4,5)*m_Z**-2 &
                  -4d0/(dsqrt(2d0))/(Spaa(1,2))/(Spaa(1,2)*Spbb(1,2))*Spaa(1,2)*Spaa(3,5)*Spbb(1,2)*Spbb(1,4) &
                  -2d0/(dsqrt(2d0))/(Spaa(1,2))/(Spaa(1,5)*Spbb(1,5))*Spaa(1,3)*Spaa(1,5)*Spaa(2,5)*Spbb(1,2)*Spbb(1,4)*Spbb(1,5)*m_Z**-2 &
                  -2d0/(dsqrt(2d0))/(Spaa(1,2))/(Spaa(1,5)*Spbb(1,5))*Spaa(1,5)*Spaa(2,3)*Spaa(2,5)*Spbb(1,2)*Spbb(1,5)*Spbb(2,4)*m_Z**-2 &
                 + 2d0/(dsqrt(2d0))/(Spaa(1,2))/(Spaa(1,5)*Spbb(1,5))*Spaa(1,5)*Spaa(2,5)*Spaa(3,5)*Spbb(1,2)*Spbb(1,5)*Spbb(4,5)*m_Z**-2 &
                 + 4d0/(dsqrt(2d0))/(Spaa(1,2))/(Spaa(1,5)*Spbb(1,5))*Spaa(2,5)*Spaa(3,5)*Spbb(1,5)*Spbb(2,4)!+LL
      else!J2 is right
        qqffbHa1 =-2d0/(dsqrt(2d0))/(Spaa(1,2))/(Spaa(1,2)*Spbb(1,2))*Spaa(1,2)*Spaa(1,4)*Spaa(2,5)*Spbb(1,2)**2*Spbb(1,3)*m_Z**-2 &
                  -2d0/(dsqrt(2d0))/(Spaa(1,2))/(Spaa(1,2)*Spbb(1,2))*Spaa(1,2)*Spaa(2,4)*Spaa(2,5)*Spbb(1,2)**2*Spbb(2,3)*m_Z**-2 &
                 + 2d0/(dsqrt(2d0))/(Spaa(1,2))/(Spaa(1,2)*Spbb(1,2))*Spaa(1,2)*Spaa(2,5)*Spaa(4,5)*Spbb(1,2)**2*Spbb(3,5)*m_Z**-2 &
                  -4d0/(dsqrt(2d0))/(Spaa(1,2))/(Spaa(1,2)*Spbb(1,2))*Spaa(1,2)*Spaa(4,5)*Spbb(1,2)*Spbb(1,3) &
                  -2d0/(dsqrt(2d0))/(Spaa(1,2))/(Spaa(1,5)*Spbb(1,5))*Spaa(1,4)*Spaa(1,5)*Spaa(2,5)*Spbb(1,2)*Spbb(1,3)*Spbb(1,5)*m_Z**-2 &
                  -2d0/(dsqrt(2d0))/(Spaa(1,2))/(Spaa(1,5)*Spbb(1,5))*Spaa(1,5)*Spaa(2,4)*Spaa(2,5)*Spbb(1,2)*Spbb(1,5)*Spbb(2,3)*m_Z**-2 &
                 + 2d0/(dsqrt(2d0))/(Spaa(1,2))/(Spaa(1,5)*Spbb(1,5))*Spaa(1,5)*Spaa(2,5)*Spaa(4,5)*Spbb(1,2)*Spbb(1,5)*Spbb(3,5)*m_Z**-2 &
                 + 4d0/(dsqrt(2d0))/(Spaa(1,2))/(Spaa(1,5)*Spbb(1,5))*Spaa(2,5)*Spaa(4,5)*Spbb(1,5)*Spbb(2,3)!+LR
      endif
    else!J1 is right
      if(id(6)*helicity(6).lt.0d0)then!J2 is left
        qqffbHa1 =-4d0/(dsqrt(2d0))/(Spaa(1,2))/(Spaa(1,5)*Spbb(1,5))*Spaa(1,2)*Spaa(2,3)*Spbb(1,4)*Spbb(1,5) &
                 + 4d0/(dsqrt(2d0))/(Spaa(1,2))/(Spaa(1,5)*Spbb(1,5))*Spaa(2,3)*Spaa(2,5)*Spbb(1,5)*Spbb(4,5)!+RL
      else!J2 is right
        qqffbHa1 =-4d0/(dsqrt(2d0))/(Spaa(1,2))/(Spaa(1,5)*Spbb(1,5))*Spaa(1,2)*Spaa(2,4)*Spbb(1,3)*Spbb(1,5) &
                 + 4d0/(dsqrt(2d0))/(Spaa(1,2))/(Spaa(1,5)*Spbb(1,5))*Spaa(2,4)*Spaa(2,5)*Spbb(1,5)*Spbb(3,5)!+RR
      endif
    endif
  endif
