!--YaofuZhou-----------------------------------------
module ModffbHBox9_10mpm
  use ModParameters
  use ModMisc
  use COLLIER
  implicit none
  public :: ffbHBox9_10mpm

contains

subroutine ffbHBox9_10mpm(MomExt,Spaa,Spbb,sprod,Box9_10)
  implicit none
  ...
  D123 = Dcoeff(0,1,1,1)
     ...
     & dsqrt(2d0))/(Spaa(1,2))/(dsqrt(2d0))/(Spbb(1,2))*Spaa(1,2)*Spaa(2,&
     & 3)*Spaa(3,4)*Spbb(1,3)*Spbb(1,4)**2*D12*mloop
      Box9_10 = Box9_10 + 16d0/(dsqrt(2d0))/(Spaa(1,2))/(dsqrt(2d0))/(Spbb(1,2))*Spaa(&
     & 1,2)*Spaa(2,4)*Spaa(3,4)*Spbb(1,4)**3*D12*mloop + 16d0/(dsqrt(2d0)&
     ...
     & )*Spbb(1,4)**2*D22*mloop - 16d0/(dsqrt(2d0))/(Spaa(1,2))/(dsqrt(2d0&
     & ))/(Spbb(1,2))*Spaa(1,3)*Spaa(2,3)*Spaa(2,4)*Spbb(1,3)*Spbb(1,4)&
     & **2*D12*mloop + 16d0/(dsqrt(2d0))/(Spaa(1,2))/(dsqrt(2d0))/(Spbb(1,&
     & 2))*Spaa(1,3)*Spaa(2,4)**2*Spbb(1,4)**3*D2*mloop + 32d0/(dsqrt(2d0&
     ...
     & 2,3)**2*Spbb(1,3)*Spbb(1,4)**2*D2*mloop - 32d0/(dsqrt(2d0))/(Spaa(&
     & 1,2))/(dsqrt(2d0))/(Spbb(1,2))*Spaa(1,4)*Spaa(2,3)**2*Spbb(1,3)*&
     & Spbb(1,4)**2*D22*mloop
      Box9_10 = Box9_10 + 16d0/(dsqrt(2d0))/(Spaa(1,2))/(dsqrt(2d0))/(Spbb(1,2))*Spaa(&
     & 1,4)*Spaa(2,3)**2*Spbb(1,3)*Spbb(1,4)**2*D12*mloop - 16d0/(dsqrt(&
     & 2d0))/(Spaa(1,2))/(dsqrt(2d0))/(Spbb(1,2))*Spaa(1,4)*Spaa(2,3)*&
     & Spaa(2,4)*Spbb(1,4)**3*D2*mloop - 32d0/(dsqrt(2d0))/(Spaa(1,2))/(&
     & dsqrt(2d0))/(Spbb(1,2))*Spaa(1,4)*Spaa(2,3)*Spaa(2,4)*Spbb(1,4)**&
     & 3*D22*mloop + 16d0/(dsqrt(2d0))/(Spaa(1,2))/(dsqrt(2d0))/(Spbb(1,2)&
     & )*Spaa(1,4)*Spaa(2,3)*Spaa(2,4)*Spbb(1,4)**3*D12*mloop - 16d0/(&
     & dsqrt(2d0))/(Spaa(1,2))/(dsqrt(2d0))/(Spbb(1,2))*Spaa(2,3)**3*&
     & Spbb(1,2)*Spbb(1,3)*Spbb(3,4)*D2*mloop - 16d0/(dsqrt(2d0))/(Spaa(1&
     & ,2))/(dsqrt(2d0))/(Spbb(1,2))*Spaa(2,3)**3*Spbb(1,2)*Spbb(1,3)*&
     & Spbb(3,4)*D22*mloop + 16d0/(dsqrt(2d0))/(Spaa(1,2))/(dsqrt(2d0))/(&
     & Spbb(1,2))*Spaa(2,3)**3*Spbb(1,2)*Spbb(1,3)*Spbb(3,4)*D23*mloop&
     &  - 16d0/(dsqrt(2d0))/(Spaa(1,2))/(dsqrt(2d0))/(Spbb(1,2))*Spaa(2,3)&
     & **3*Spbb(1,3)**2*Spbb(2,4)*D22*mloop - 16d0/(dsqrt(2d0))/(Spaa(1,2&
     & ))/(dsqrt(2d0))/(Spbb(1,2))*Spaa(2,3)**3*Spbb(1,3)**2*Spbb(2,4)*&
     & D23*mloop
      Box9_10 = Box9_10 + 16d0/(dsqrt(2d0))/(Spaa(1,2))/(dsqrt(2d0))/(Spbb(1,2))*Spaa(&
     & 2,3)**3*Spbb(1,3)*Spbb(1,4)*Spbb(2,3)*D22*mloop + 16d0/(dsqrt(2d0)&
     & )/(Spaa(1,2))/(dsqrt(2d0))/(Spbb(1,2))*Spaa(2,3)**3*Spbb(1,3)*&
     & Spbb(1,4)*Spbb(2,3)*D23*mloop - 16d0/(dsqrt(2d0))/(Spaa(1,2))/(&
     & dsqrt(2d0))/(Spbb(1,2))*Spaa(2,3)**2*Spaa(2,4)*Spbb(1,2)*Spbb(1,4&
     & )*Spbb(3,4)*D2*mloop - 16d0/(dsqrt(2d0))/(Spaa(1,2))/(dsqrt(2d0))/(&
     & Spbb(1,2))*Spaa(2,3)**2*Spaa(2,4)*Spbb(1,2)*Spbb(1,4)*Spbb(3,4)*&
     & D22*mloop + 16d0/(dsqrt(2d0))/(Spaa(1,2))/(dsqrt(2d0))/(Spbb(1,2))*&
     & Spaa(2,3)**2*Spaa(2,4)*Spbb(1,2)*Spbb(1,4)*Spbb(3,4)*D23*mloop&
     &  - 16d0/(dsqrt(2d0))/(Spaa(1,2))/(dsqrt(2d0))/(Spbb(1,2))*Spaa(2,3)&
  ...
  return
end subroutine ffbHBox9_10mpm

end module ModffbHBox9_10mpm
!!--YaofuZhou-----------------------------------------
