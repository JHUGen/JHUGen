...
subroutine ggbox5HH6mm(mom,Spaa,Spbb,sprod,ggbox5HH6)
  implicit none
  ...
  D3333 = Dcoeff(0,0,0,4)
     ...
     & Spbb(1,2)**3*D12 + 4d0/(dsqrt(2d0))/(Spbb(1,2))/(dsqrt(2d0))/(Spbb(&
     & 1,2))*Spaa(1,2)**3*Spbb(1,2)**3*D112 + 4d0/(dsqrt(2d0))/(Spbb(1,2)&
     & )/(dsqrt(2d0))/(Spbb(1,2))*Spaa(1,2)**3*Spbb(1,2)**3*D221 + 8d0/(&
     & dsqrt(2d0))/(Spbb(1,2))/(dsqrt(2d0))/(Spbb(1,2))*Spaa(1,2)**3*&
     & Spbb(1,2)**3*D1122 + 4d0/(dsqrt(2d0))/(Spbb(1,2))/(dsqrt(2d0))/(&
     ...
     & ))/(dsqrt(2d0))/(Spbb(1,2))*Spaa(1,2)**2*Spaa(1,3)*Spbb(1,2)**2*&
     & Spbb(1,3)*D222
      ggbox5HH6 = ggbox5HH6 + 16d0/(dsqrt(2d0))/(Spbb(1,2))/(dsqrt(2d0))/(&
     ...
     & )/(dsqrt(2d0))/(Spbb(1,2))*Spaa(1,2)**2*Spaa(1,4)*Spbb(1,2)**2*&
     & Spbb(1,4)*D123
      ggbox5HH6 = ggbox5HH6 + 4d0/(dsqrt(2d0))/(Spbb(1,2))/(dsqrt(2d0))/(&
     ...
     & ))/(dsqrt(2d0))/(Spbb(1,2))*Spaa(1,2)**2*Spaa(2,4)*Spbb(1,2)**2*&
     & Spbb(2,4)*D113
      ggbox5HH6 = ggbox5HH6 - 8d0/(dsqrt(2d0))/(Spbb(1,2))/(dsqrt(2d0))/(&
     ...
     & ))/(dsqrt(2d0))/(Spbb(1,2))*Spaa(1,2)**2*Spaa(3,4)*Spbb(1,2)**2*&
     & Spbb(3,4)*D23
      ggbox5HH6 = ggbox5HH6 - 24d0/(dsqrt(2d0))/(Spbb(1,2))/(dsqrt(2d0))/(&
     ...
     & Spbb(1,4)*Spbb(2,4)*D1233
      ggbox5HH6 = ggbox5HH6 - 12d0/(dsqrt(2d0))/(Spbb(1,2))/(dsqrt(2d0))/(&
     ...
     & 4)*Spbb(3,4)*D2222
      ggbox5HH6 = ggbox5HH6 - 48d0/(dsqrt(2d0))/(Spbb(1,2))/(dsqrt(2d0))/(&
     & Spbb(1,2))*Spaa(1,2)*Spaa(1,4)*Spaa(3,4)*Spbb(1,2)*Spbb(1,4)*&
     ...
     & ,4)*Spbb(1,2)*Spbb(2,3)*Spbb(2,4)*D1122
      ggbox5HH6 = ggbox5HH6 + 32d0/(dsqrt(2d0))/(Spbb(1,2))/(dsqrt(2d0))/(&
     & Spbb(1,2))*Spaa(1,2)*Spaa(2,3)*Spaa(2,4)*Spbb(1,2)*Spbb(2,3)*&
     ...
     & 2)*D0*mloop**4
      ggbox5HH6 = ggbox5HH6 - 64d0/(dsqrt(2d0))/(Spbb(1,2))/(dsqrt(2d0))/(&
     & Spbb(1,2))*Spaa(1,2)*Spbb(1,2)*D00*mloop**2 + 192d0/(dsqrt(2d0))/(&
     & Spbb(1,2))/(dsqrt(2d0))/(Spbb(1,2))*Spaa(1,2)*Spbb(1,2)*D0000 + 8d0&
     & /(dsqrt(2d0))/(Spbb(1,2))/(dsqrt(2d0))/(Spbb(1,2))*Spaa(1,3)*Spaa(&
     & 2,3)*Spbb(1,3)*Spbb(2,3)*D0*mloop**2 - 16d0/(dsqrt(2d0))/(Spbb(1,2&
     & ))/(dsqrt(2d0))/(Spbb(1,2))*Spaa(1,3)*Spaa(2,3)*Spbb(1,3)*Spbb(2,&
     & 3)*D00 + 8d0/(dsqrt(2d0))/(Spbb(1,2))/(dsqrt(2d0))/(Spbb(1,2))*&
     & Spaa(1,3)*Spaa(2,4)*Spbb(1,4)*Spbb(2,3)*D0*mloop**2 - 16d0/(&
     & dsqrt(2d0))/(Spbb(1,2))/(dsqrt(2d0))/(Spbb(1,2))*Spaa(1,3)*Spaa(2,&
     & 4)*Spbb(1,4)*Spbb(2,3)*D00 + 8d0/(dsqrt(2d0))/(Spbb(1,2))/(dsqrt(&
     & 2d0))/(Spbb(1,2))*Spaa(1,4)*Spaa(2,3)*Spbb(1,3)*Spbb(2,4)*D0*&
     ...
     & *Spbb(2,4)*D0*mloop**2 - 16d0/(dsqrt(2d0))/(Spbb(1,2))/(dsqrt(2d0))&
     & /(Spbb(1,2))*Spaa(1,4)*Spaa(2,4)*Spbb(1,4)*Spbb(2,4)*D00
  
  return
end subroutine ggbox5HH6mm

end module Modggbox5HH6mm
!!--YaofuZhou-----------------------------------------