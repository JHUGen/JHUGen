...
subroutine ggbox5HH2mp(mom,Spaa,Spbb,sprod,ggbox5HH2)
  implicit none
  ...
  D3333 = Dcoeff(0,0,0,4)
     ...
     & Spbb(1,3)*Spbb(2,3)**2*D2222 + 8d0/(dsqrt(2d0))/(Spbb(1,2))/(&
     & dsqrt(2d0))/(Spaa(1,2))*Spaa(1,3)**3*Spbb(1,3)*Spbb(2,3)**2*D2223&
     ...
     & Spbb(1,3)*Spbb(2,3)*Spbb(2,4)*D2222 + 16d0/(dsqrt(2d0))/(Spbb(1,2)&
     ...
     & Spaa(1,4)*Spbb(1,4)*Spbb(2,3)**2*D2222 + 8d0/(dsqrt(2d0))/(Spbb(1,&
     & 2))/(dsqrt(2d0))/(Spaa(1,2))*Spaa(1,3)**2*Spaa(1,4)*Spbb(1,4)*&
     & Spbb(2,3)**2*D2223 - 8d0/(dsqrt(2d0))/(Spbb(1,2))/(dsqrt(2d0))/(&
     & Spaa(1,2))*Spaa(1,3)**2*Spaa(2,3)*Spbb(2,3)**3*D1222 - 8d0/(&
     & dsqrt(2d0))/(Spbb(1,2))/(dsqrt(2d0))/(Spaa(1,2))*Spaa(1,3)**2*&
     & Spaa(2,4)*Spbb(2,3)**2*Spbb(2,4)*D1222 - 8d0/(dsqrt(2d0))/(Spbb(1,&
     ...
     & dsqrt(2d0))/(Spbb(1,2))/(dsqrt(2d0))/(Spaa(1,2))*Spaa(1,3)**2*&
     & Spbb(2,3)**2*D2*mloop**2 - 8d0/(dsqrt(2d0))/(Spbb(1,2))/(dsqrt(2d0)&
     ...
     & Spaa(1,3)*Spaa(1,4)*Spbb(2,3)*Spbb(2,4)*D2*mloop**2 - 16d0/(&
     ...
     & **2*D2*mloop**2 - 8d0/(dsqrt(2d0))/(Spbb(1,2))/(dsqrt(2d0))/(Spaa(1&
     & ,2))*Spaa(1,4)**2*Spbb(2,4)**2*D22*mloop**2 - 16d0/(dsqrt(2d0))/(&
  ...
  return
end subroutine ggbox5HH2mp

end module Modggbox5HH2mp
!!--YaofuZhou-----------------------------------------