...
subroutine ggbox5HH3mp(mom,Spaa,Spbb,sprod,ggbox5HH3)
  implicit none
  ...
  D3333 = Dcoeff(0,0,0,4)
     ...
     &  + 8d0/(dsqrt(2d0))/(Spbb(1,2))/(dsqrt(2d0))/(Spaa(1,2))*Spaa(1,3)&
     & **2*Spbb(2,3)**2*D2*mloop**2 - 8d0/(dsqrt(2d0))/(Spbb(1,2))/(&
     ...
     & mloop**2 - 8d0/(dsqrt(2d0))/(Spbb(1,2))/(dsqrt(2d0))/(Spaa(1,2))*&
  ...
  return
end subroutine ggbox5HH3mp

end module Modggbox5HH3mp
!!--YaofuZhou-----------------------------------------