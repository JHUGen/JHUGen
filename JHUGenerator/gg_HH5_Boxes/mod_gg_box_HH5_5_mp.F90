...
subroutine ggbox5HH5mp(mom,Spaa,Spbb,sprod,ggbox5HH5)
  implicit none
  ...
  D3333 = Dcoeff(0,0,0,4)
     ...
     & Spaa(1,2))*Spaa(1,3)**2*Spbb(2,3)**2*D0*mloop**2 - 16d0/(dsqrt(2d0&
     & ))/(Spbb(1,2))/(dsqrt(2d0))/(Spaa(1,2))*Spaa(1,3)**2*Spbb(2,3)**2&
     & *D00 + 16d0/(dsqrt(2d0))/(Spbb(1,2))/(dsqrt(2d0))/(Spaa(1,2))*Spaa(&
     & 1,3)*Spaa(1,4)*Spbb(2,3)*Spbb(2,4)*D0*mloop**2 - 32d0/(dsqrt(2d0))&
     & /(Spbb(1,2))/(dsqrt(2d0))/(Spaa(1,2))*Spaa(1,3)*Spaa(1,4)*Spbb(2,&
     & 3)*Spbb(2,4)*D00
      ggbox5HH5 = ggbox5HH5 + 8d0/(dsqrt(2d0))/(Spbb(1,2))/(dsqrt(2d0))/(&
     & Spaa(1,2))*Spaa(1,4)**2*Spbb(2,4)**2*D0*mloop**2 - 16d0/(dsqrt(2d0&
     & ))/(Spbb(1,2))/(dsqrt(2d0))/(Spaa(1,2))*Spaa(1,4)**2*Spbb(2,4)**2&
     & *D00
  
  return
end subroutine ggbox5HH5mp

end module Modggbox5HH5mp
!!--YaofuZhou-----------------------------------------