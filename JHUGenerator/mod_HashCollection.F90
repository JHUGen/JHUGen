...
implicit none
   ...
   Hash_MCFM_qqVVqq( 10,:) = (/ Up_ , AChm_ , AStr_ , Dn_ /)
   Hash_MCFM_qqVVqq( 11,:) = (/ AChm_ , Up_ , AStr_ , Dn_ /)
   Hash_MCFM_qqVVqq( 12,:) = (/ AStr_ , Dn_ , AChm_ , Up_ /)
   Hash_MCFM_qqVVqq( 13,:) = (/ Dn_ , AStr_ , AChm_ , Up_ /)
   Hash_MCFM_qqVVqq( 14,:) = (/ Dn_ , Chm_ , Up_ , Str_ /)
   Hash_MCFM_qqVVqq( 15,:) = (/ Chm_ , Dn_ , Up_ , Str_ /)
   Hash_MCFM_qqVVqq( 16,:) = (/ ADn_ , AUp_ , AUp_ , ADn_ /)
   Hash_MCFM_qqVVqq( 17,:) = (/ AUp_ , ADn_ , AUp_ , ADn_ /)
   Hash_MCFM_qqVVqq( 18,:) = (/ AChm_ , ADn_ , AStr_ , AUp_ /)
   Hash_MCFM_qqVVqq( 19,:) = (/ ADn_ , AChm_ , AStr_ , AUp_ /)
   Hash_MCFM_qqVVqq( 20,:) = (/ Dn_ , Dn_ , Dn_ , Dn_ /)
   Hash_MCFM_qqVVqq( 21,:) = (/ ADn_ , Str_ , AUp_ , Chm_ /)
   Hash_MCFM_qqVVqq( 22,:) = (/ Str_ , ADn_ , AUp_ , Chm_ /)
   Hash_MCFM_qqVVqq( 23,:) = (/ AUp_ , AStr_ , AChm_ , ADn_ /)
   Hash_MCFM_qqVVqq( 24,:) = (/ AStr_ , AUp_ , AChm_ , ADn_ /)
   Hash_MCFM_qqVVqq( 25,:) = (/ AStr_ , Str_ , AChm_ , Chm_ /)
   Hash_MCFM_qqVVqq( 26,:) = (/ Str_ , AStr_ , AChm_ , Chm_ /)
   Hash_MCFM_qqVVqq( 27,:) = (/ Up_ , ADn_ , ADn_ , Up_ /)
   Hash_MCFM_qqVVqq( 28,:) = (/ ADn_ , Up_ , ADn_ , Up_ /)
   Hash_MCFM_qqVVqq( 29,:) = (/ AUp_ , Up_ , AUp_ , Up_ /)
   Hash_MCFM_qqVVqq( 30,:) = (/ Up_ , AUp_ , AUp_ , Up_ /)
   Hash_MCFM_qqVVqq( 31,:) = (/ Dn_ , ADn_ , ADn_ , Dn_ /)
   Hash_MCFM_qqVVqq( 32,:) = (/ ADn_ , Dn_ , ADn_ , Dn_ /)
   Hash_MCFM_qqVVqq( 33,:) = (/ Chm_ , AUp_ , ADn_ , Str_ /)
   Hash_MCFM_qqVVqq( 34,:) = (/ AUp_ , Chm_ , ADn_ , Str_ /)
   Hash_MCFM_qqVVqq( 35,:) = (/ Up_ , Str_ , Up_ , Str_ /)
   Hash_MCFM_qqVVqq( 36,:) = (/ Str_ , Up_ , Up_ , Str_ /)
   Hash_MCFM_qqVVqq( 37,:) = (/ AChm_ , AStr_ , AChm_ , AStr_ /)
   Hash_MCFM_qqVVqq( 38,:) = (/ AStr_ , AChm_ , AChm_ , AStr_ /)
   ...
   Hash_MCFM_qqVVqq(137,:) = (/ Chm_ , Str_ , Str_ , Chm_ /)  
   ...
   Hash_MCFM_qqVVqq(142,:) = (/ ABot_ , AChm_ , ABot_ , AChm_ /)
   ...
   Hash_MCFM_qqVVqq(149,:) = (/ AStr_ , AUp_ , AStr_ , AUp_ /)
   Hash_MCFM_qqVVqq(150,:) = (/ ABot_ , AUp_ , ABot_ , AUp_ /)   
