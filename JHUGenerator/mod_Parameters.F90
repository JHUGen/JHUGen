...
real(8), public, parameter :: VBF_4ml_minmax(1:2) = (/ 200d0,14000d0 /)*GeV  ! min and max for m_4l in off-shell VBF production, default is (-1,-1): m_4l ~ Higgs resonance (on-shell)
!=====================================================
