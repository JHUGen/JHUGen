...
! 
! 
character(len=6),parameter :: JHUGen_Version="v5.1.7"
! 
! 
...
real(8), public :: scale_alpha_Z_uu = 1.0366d0 ! scaling factor of alpha (~partial width) for Z > u u~, c c~
real(8), public :: scale_alpha_Z_dd = 1.0366d0 ! scaling factor of alpha (~partial width) for Z > d d~, s s~, b b~
real(8), public :: scale_alpha_W_ud = 1.0993819d0 ! scaling factor of alpha (~partial width) for W > u d
real(8), public :: scale_alpha_W_cs = 1.0993819d0 ! scaling factor of alpha (~partial width) for W > c s
real(8), public :: scale_alpha_Z_ll = 1d0 ! scaling factor of alpha (~partial width) for Z > l+ l-
real(8), public :: scale_alpha_Z_nn = 1d0 ! scaling factor of alpha (~partial width) for Z > nu nu~
real(8), public :: scale_alpha_W_ln = 1d0 ! scaling factor of alpha (~partial width) for W > l nu
