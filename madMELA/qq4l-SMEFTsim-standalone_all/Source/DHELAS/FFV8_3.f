...
C     
     ...
     $ *P3(3)))
      TMP9 = (F1(5)*-F2(5)*(-P3(0)*P3(0)+P3(1)*P3(1)+P3(2)*P3(2)+P3(3)
     ...
     $ -F2(4)*F1(4)-F2(5)*F1(5))+1D0/2D0*(OM3*P3(0)*(-TMP7+TMP8+TMP9)))
     $ ))
     ...
     $ +F2(4)*F1(3)+F2(6)*F1(5))+1D0/2D0*(OM3*P3(1)*(-TMP7+TMP8+TMP9)))
     $ ))
     ...
     $ -1D0/2D0*(OM3*P3(2)*(-CI*(TMP7)+CI*(TMP8+TMP9))))))
     ...
     $ +F2(6)*F1(5)))-1D0/2D0*(OM3*P3(3)*(-TMP7+TMP8+TMP9)))))
      END
