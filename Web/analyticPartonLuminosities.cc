// Example, run in ROOT:
// [] .x analyticPartonLuminosities.cc+(13) // 13 for sqrts in TeV
...
void analyticPartonLuminosities(double sqrts){
  sqrts *= 1e3;

  double testPoint1_qq  = pdfs_qqbar(10, 0, sqrts);
  double testPoint1_gg  = pdfs_gg(10, 0, sqrts);
  double testPoint1_qqp = pdfs_qqbarPrime(10, 0, sqrts);

  double testPoint2_qq  = pdfs_qqbar(100, 0, sqrts);
  double testPoint2_gg  = pdfs_gg(100, 0, sqrts);
  double testPoint2_qqp = pdfs_qqbarPrime(100, 0, sqrts);

  double testPoint3_qq  = pdfs_qqbar(1000, 0, sqrts);
  double testPoint3_gg  = pdfs_gg(1000, 0, sqrts);
  double testPoint3_qqp = pdfs_qqbarPrime(1000, 0, sqrts);
