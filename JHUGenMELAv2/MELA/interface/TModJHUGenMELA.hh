...
extern "C" {
  ...
  void __modjhugenmela_MOD_setspinzerocontactterms(double Hzpcontact[SIZE_Vp][2], double Hwpcontact[SIZE_Vp][2], int* UseVp, double* M_Vp, double* Ga_Vp, int* OnlyVVp);
